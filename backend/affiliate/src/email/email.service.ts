...
export class EmailService {
  ...
  private generatePasswordResetTemplate(resetUrl: string, userName?: string, resetToken?: string): string {
    return `
      <!DOCTYPE html>
      <html>
      <head>
  ...
  private generateWelcomeTemplate(userName: string, tempPassword?: string): string {
    return `
      <!DOCTYPE html>
      <html>
      <head>
