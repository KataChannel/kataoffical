...
exports.DoanhthuService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma/prisma.service");
const errorlog_service_1 = require("../errorlog/errorlog.service");
const socket_gateway_1 = require("../socket.gateway");
let DoanhthuService = class DoanhthuService {
    ...
    async findOne(id) {
        try {
            ...
            if (!item)
                throw new common_1.NotFoundException('Doanhthu not found');
            return item;
        }
        catch (error) {
    ...
    async reorderDoanhthus(doanhthuIds) {
        try {
...
exports.DoanhthuService = DoanhthuService;
exports.DoanhthuService = DoanhthuService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        socket_gateway_1.SocketGateway,
        errorlog_service_1.ErrorlogService])
], DoanhthuService);
//# sourceMappingURL=doanhthu.service.js.map