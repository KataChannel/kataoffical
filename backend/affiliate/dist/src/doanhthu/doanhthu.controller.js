...
exports.DoanhthuController = void 0;
const common_1 = require("@nestjs/common");
const doanhthu_service_1 = require("./doanhthu.service");
const swagger_1 = require("@nestjs/swagger");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
let DoanhthuController = class DoanhthuController {
    constructor(doanhthuService) {
    ...
    async findAll(page = '1', limit = '10') {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to fetch doanhthus', error.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
exports.DoanhthuController = DoanhthuController;
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new doanhthu' }),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "findby", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all doanhthus with pagination' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of doanhthus with pagination info' }),
    ...
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "findAll", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get last updated doanhthu' }),
    (0, common_1.Get)('lastupdated'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "getLastUpdatedDoanhthu", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find doanhthu by ID' }),
    ...
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "findOne", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a doanhthu' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, swagger_1.ApiBody)({ type: Object }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id'),
    ...
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "update", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a doanhthu' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "remove", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Reorder doanhthus' }),
    (0, swagger_1.ApiBody)({
        schema: {
            properties: {
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DoanhthuController.prototype, "reorder", null);
exports.DoanhthuController = DoanhthuController = __decorate([
    (0, swagger_1.ApiTags)('doanhthu'),
    (0, common_1.Controller)('doanhthu'),
    __metadata("design:paramtypes", [doanhthu_service_1.DoanhthuService])
], DoanhthuController);
//# sourceMappingURL=doanhthu.controller.js.map