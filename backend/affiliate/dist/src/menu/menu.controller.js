...
let MenuController = class MenuController {
    ...
    async getLastUpdated() {
        return this.menuService.getLastUpdated();
    }
    findby(param) {
        return this.menuService.findby(param);
    }
    getTree(data) {
...
], MenuController.prototype, "getLastUpdated", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], MenuController.prototype, "findby", null);
__decorate([
