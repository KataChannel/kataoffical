...
exports.ThanhtoanhoahongService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma/prisma.service");
const errorlog_service_1 = require("../errorlog/errorlog.service");
const socket_gateway_1 = require("../socket.gateway");
let ThanhtoanhoahongService = class ThanhtoanhoahongService {
    ...
    async findOne(id) {
        try {
            ...
            if (!item)
                throw new common_1.NotFoundException('Thanhtoanhoahong not found');
            return item;
        }
        catch (error) {
    ...
    async reorderThanhtoanhoahongs(thanhtoanhoahongIds) {
        try {
...
exports.ThanhtoanhoahongService = ThanhtoanhoahongService;
exports.ThanhtoanhoahongService = ThanhtoanhoahongService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        socket_gateway_1.SocketGateway,
        errorlog_service_1.ErrorlogService])
], ThanhtoanhoahongService);
//# sourceMappingURL=thanhtoanhoahong.service.js.map