...
export class AffiliatelinkController { 
  ...
  @ApiBearerAuth() 
  @ApiOperation({ summary: 'Create a new affiliatelink' }) 
  @ApiBody({ type: Object }) 
  ...
  @ApiOperation({ summary: 'Find affiliatelinks by parameters' })
  @ApiBody({ type: Object }) 
  @Post('findby')
  ...
  @ApiOperation({ summary: 'Get all affiliatelinks with pagination' })
  @ApiQuery({ name: 'page', required: false, type: Number, description: 'Page number (default: 1)' })
  @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Number of items per page (default: 10)' })
  @ApiResponse({ status: 200, description: 'List of affiliatelinks with pagination info' })
  ...
  @ApiOperation({ summary: 'Find affiliatelink by ID' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Update a affiliatelink' })
  @ApiParam({ name: 'id', type: String })
  @ApiBody({ type: Object }) 
  @UseGuards(JwtAuthGuard)
  @Patch(':id')
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Delete a affiliatelink' })
  @ApiParam({ name: 'id', type: String })
  @UseGuards(JwtAuthGuard)
  @Delete(':id')
  ...
  @ApiOperation({ summary: 'Reorder affiliatelinks' })
  @ApiBody({
    schema: { 
      properties: {
  ...
  @Post('reorder') 
  async reorder(@Body() body: { affiliatelinkIds: string[] }) { 
    try {
