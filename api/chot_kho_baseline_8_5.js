...
async function performBaselineChot() {
  try {
    const filePath = '/home/kata/Coding/rausachfinal/doisoat/Ton-Huy 8-5.xlsx';
    ...
    const chotkhoMaster = await prisma.chotkho.create({
      data: {
        ngaychot: new Date('2026-05-08T23:59:59'), // Set to end of day
        title: `Chốt kho Base Line 08-05-2026`,
        ghichu: 'Chốt kho Base Line từ file Ton-Huy 8-5.xlsx',
        khoId: KHO_TONG_ID,
        codeId: `CHOTKHO_BASELINE_0805_${Date.now()}`,
        isActive: true
      }
    });
