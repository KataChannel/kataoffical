...
__decorate([
    (0, common_1.Get)(':banggiaId/sanpham/:sanphamId/price-history'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get price history for a product in banggia' }),
    ...
    __metadata("design:returntype", void 0)
], BanggiaController.prototype, "getPriceHistory", null);
__decorate([
    (0, common_1.Get)(':banggiaId/sanpham/:sanphamId/current-price'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get current price for a product in banggia' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Current price retrieved successfully' }),
    __param(0, (0, common_1.Param)('banggiaId')),
    __param(1, (0, common_1.Param)('sanphamId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], BanggiaController.prototype, "getCurrentPrice", null);
__decorate([
    (0, common_1.Post)('bulk-update-prices'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Bulk update prices with audit trail' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Prices updated successfully' }),
    (0, audit_decorator_1.Audit)({ entity: 'Bulk Update Prices', action: client_1.AuditAction.UPDATE, includeResponse: true }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], BanggiaController.prototype, "bulkUpdatePrices", null);
