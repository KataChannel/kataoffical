...
let BanggiaController = class BanggiaController {
    ...
    async findAll(page = '1', limit = '10') {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to fetch banggias', error.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find banggias by parameters' }),
    (0, swagger_1.ApiBody)({ type: Object }),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BanggiaController.prototype, "findby", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all banggias with pagination' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of banggias with pagination info' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get last updated banggia' }),
    (0, common_1.Get)('lastupdated'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BanggiaController.prototype, "getLastUpdatedBanggia", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find banggia by ID' }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a banggia' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Reorder banggias' }),
    (0, swagger_1.ApiBody)({
        schema: {
            properties: {
