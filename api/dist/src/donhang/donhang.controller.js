...
__decorate([
    (0, common_1.Get)('verify-prices/:donhangId'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Verify order prices against current banggia prices' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Price verification result' }),
    __param(0, (0, common_1.Param)('donhangId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DonhangController.prototype, "verifyOrderPrices", null);
__decorate([
    (0, common_1.Get)('price-at-date'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Get price at specific date from history' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Historical price data' }),
    __param(0, (0, common_1.Query)('banggiaId')),
    __param(1, (0, common_1.Query)('sanphamId')),
    __param(2, (0, common_1.Query)('date')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", Promise)
], DonhangController.prototype, "getPriceAtDate", null);
