...
let DonhangController = class DonhangController {
    ...
    async findAll(page = '1', limit = '10') {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to fetch donhangs', error.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new donhang' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find donhangs by parameters' }),
    (0, swagger_1.ApiBody)({ type: Object }),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DonhangController.prototype, "findby", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all donhangs with pagination' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of donhangs with pagination info' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get last updated donhang' }),
    (0, common_1.Get)('lastupdated'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], DonhangController.prototype, "getLastUpdatedDonhang", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find donhang by ID' }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a donhang' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, swagger_1.ApiBody)({ type: Object }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id'),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a donhang' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Reorder donhangs' }),
    (0, swagger_1.ApiBody)({
        schema: {
            properties: {
