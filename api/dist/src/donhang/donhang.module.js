...
const donhang_price_controller_1 = require("./donhang-price.controller");
...
exports.DonhangModule = DonhangModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [donhang_service_1.DonhangService, cancel_order_service_1.CancelOrderService, price_history_service_1.PriceHistoryService]
    })
], DonhangModule);
