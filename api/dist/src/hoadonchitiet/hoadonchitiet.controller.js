...
let HoadonchitietController = class HoadonchitietController {
    ...
    async findAll(page = '1', limit = '10') {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to fetch hoadonchitiets', error.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all hoadonchitiets with pagination' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of hoadonchitiets with pagination info' }),
