...
let EnhancedUniversalService = class EnhancedUniversalService {
    ...
    async buildOptimizedQuery(modelName, args, info) {
        ...
        if (args.select || args.include) {
            if (args.select)
                queryOptions.select = this.fieldSelection.normalizeSelection(args.select, modelName);
            if (args.include)
                queryOptions.include = this.fieldSelection.normalizeSelection(args.include, modelName);
        }
        else if (info) {
