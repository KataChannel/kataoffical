...
let KhoController = class KhoController {
    ...
    async findAll(query) {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to fetch khos', error.status || common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create a new kho' }),
    (0, swagger_1.ApiBody)({ type: Object }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)(),
    (0, audit_decorator_1.Audit)({ entity: 'Kho', action: client_1.AuditAction.CREATE, includeResponse: true }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find khos by parameters' }),
    (0, swagger_1.ApiBody)({ type: Object }),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], KhoController.prototype, "findby", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get all khos with pagination' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'List of khos with pagination info' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get last updated kho' }),
    (0, common_1.Get)('lastupdated'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], KhoController.prototype, "getLastUpdatedKho", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Find kho by ID' }),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update a kho' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, swagger_1.ApiBody)({ type: Object }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id'),
    (0, audit_decorator_1.Audit)({ entity: 'Kho', action: client_1.AuditAction.UPDATE, includeResponse: true }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a kho' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Delete)(':id'),
    (0, audit_decorator_1.Audit)({ entity: 'Kho', action: client_1.AuditAction.DELETE }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Reorder khos' }),
    (0, swagger_1.ApiBody)({
        schema: {
            properties: {
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], KhoController.prototype, "reorder", null);
