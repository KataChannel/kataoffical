...
async function main() {
    ...
    let excelCustomerCodes = excelData.customers.filter((c) => c.startsWith('TG-') || c.startsWith('SCC'));
    ...
    reportData.forEach(o => {
        if (!customerSummary[o.khachhang])
            customerSummary[o.khachhang] = 0;
...
//# sourceMappingURL=find_missing_orders.js.map