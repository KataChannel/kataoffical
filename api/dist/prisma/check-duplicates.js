...
const fs = require("fs");
const banggiaData = JSON.parse(fs.readFileSync('/chikiet/kataoffical/rausachfinal/api/rausach_json/20251016_165325/Banggia.json', 'utf-8'));
console.log('\n🔍 CHECKING FOR DUPLICATES IN BANGGIA BACKUP\n');
const idMap = new Map();
banggiaData.forEach((b) => {
    if (idMap.has(b.id)) {
...
const bg24 = banggiaData.find((b) => b.id === 'cc845265-66d1-4363-a1f9-5e7c9ad591aa');
console.log(`\n🎯 BG24 in backup:`);
