...
async function performBaselineChot12May() {
  try {
    const filePath = '/home/kata/Coding/rausachfinal/doisoat/Ton-Huy 12-5.xlsx';
    ...
    // 2. Identify Backlogged Orders (Status 'dadat' created before end of 12/05)
    const baselineTime = new Date('2026-05-12T23:59:59');
