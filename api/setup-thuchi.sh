...
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
  PGPASSWORD=kata@2025 psql -h 116.118.49.243 -p 55432 -U kata2025 -d rausachtrangia -f sql/add-thuchi-menu-items.sql
...
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
  PGPASSWORD=kata@2025 psql -h 116.118.49.243 -p 55432 -U kata2025 -d rausachtrangia -f sql/add-thuchi-permissions.sql
...
echo "1. Mở file test-thuchi-apis.http trong VS Code"
