...
async function performBaselineChot10May() {
  try {
    const filePath = '/home/kata/Coding/rausachfinal/doisoat/Ton-Huy 10-5.xlsx';
    ...
    // 2. Identify Backlogged Orders (Status 'dadat' created before end of 10/05)
    const baselineTime = new Date('2026-05-10T23:59:59');
