...
export class ChotkhoController {
  ...
  @ApiOperation({
    summary:
      'Create new inventory check - New Logic: Process all products in warehouse',
  })
  @ApiBody({
    schema: {
      type: 'object',
  ...
  async create(@Body() data: any) {
    try {
      ...
      throw new HttpException(
        error.message || 'Create inventory check failed',
  ...
  async getAllProductsByKho(@Param('khoId') khoId: string) {
    try {
      ...
      throw new HttpException(
        error.message || 'Get products failed',
        HttpStatus.INTERNAL_SERVER_ERROR,
      );
    }
  }
  ...
  async updateWithDetails(@Param('id') id: string, @Body() data: any) {
    try {
      ...
      throw new HttpException(
        error.message || 'Update with details failed',
        HttpStatus.INTERNAL_SERVER_ERROR,
      );
    }
  }
