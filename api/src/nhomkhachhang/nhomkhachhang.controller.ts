...
export class NhomkhachhangController {
  ...
  @UseGuards(JwtAuthGuard)
  @Audit({
    entity: 'Add Khachhang to Nhom',
    action: AuditAction.CREATE,
    includeResponse: true,
  })
  addMultipleKhachhangToNhom(@Body() data: any) {
    return this.nhomkhachhangService.addKHtoNhom(
      data.nhomId,
      data.khachhangIds,
    );
  }
  ...
  @UseGuards(JwtAuthGuard)
  @Audit({
    entity: 'Remove Khachhang from Nhom',
    action: AuditAction.DELETE,
    includeResponse: true,
  })
  removeKHfromNhom(@Body() data: any) {
    return this.nhomkhachhangService.removeKHfromNhom(
      data.nhomId,
      data.khachhangIds,
    );
  }
