...
export class UserPermissionController {
   ...
   */
  @Post('assign')
  @RequirePermissions('manage_user_permissions')
  ...
  async removeUserPermission(
    ...
    return this.userPermissionService.removeUserPermission(
      userId,
      permissionId,
    );
  }
   ...
   */
  @Get('user/:userId')
  @RequirePermissions('view_user_permissions')
  ...
  async getUserEffectivePermission(
    ...
    return this.userPermissionService.getUserEffectivePermission(
      userId,
      permissionId,
    );
  }
  ...
  async getUserEffectivePermissionByName(
    ...
    return this.userPermissionService.getUserEffectivePermissionByName(
      userId,
      permissionName,
    );
  }
  ...
  async findMany(
    ...
    return this.userPermissionService.findMany({
      ...
      permissionId,
      isGranted:
        isGranted === 'true' ? true : isGranted === 'false' ? false : undefined,
      isExpired:
