...
async function performBaselineChot26May() {
  try {
    const filePath = '/home/kata/Coding/rausachfinal/doisoat/Ton-Huy 26-5.xlsx';
    console.log(`--- Processing Baseline & Cleanup (26-05-2026): ${filePath} ---`);
    ...
    // Tomorrow is 2026-05-27
    const tomorrowStart = new Date('2026-05-27T00:00:00+07:00');
    const baselineTime = new Date('2026-05-26T23:59:59+07:00');
    ...
    const newChotkhoCodeId = `CHOTKHO_BASELINE_2605_${Date.now()}`;
    ...
    await prisma.$transaction(async (tx) => {
      ...
      const chotkhoMaster = await tx.chotkho.create({
        data: {
          ...
          title: `Chốt kho Base Line 26-05-2026`,
          ghichu: 'Chốt kho Baseline chuẩn theo file Ton-Huy 26-5.xlsx - Thay thế chốt tự động bị lỗi và xóa phiếu đối soát ảo',
          khoId: KHO_TONG_ID,
      ...
      // H. Individual update for reset products WITH pending quantities (very few)
    ...
    console.log('\n--- BASELINE 26-05 RECONCILIATION COMPLETE ---');
