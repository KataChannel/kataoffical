...
async function performBaselineChot() {
  try {
    ...
    const sheetName = 'sheet1'; // Based on inspection
    ...
    const chotkhoMaster = await prisma.chotkho.create({
      data: {
        ngaychot: new Date('2026-05-07T23:59:59'), // Set to end of day
        title: `Chốt kho Base Line 07-05-2026`,
        ghichu: 'Chốt kho Base Line từ file Ton-Huy 7-5.xlsx',
        khoId: KHO_TONG_ID,
        codeId: `CHOTKHO_BASELINE_0705_${Date.now()}`,
        isActive: true
      }
    });
