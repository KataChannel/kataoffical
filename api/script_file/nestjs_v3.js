...
// Đường dẫn tới thư mục sẽ chứa các file (ví dụ: ./userguide nếu truyền userguide)
const baseDir = path.join(__dirname, lowerCaseModuleName);

// Template cho các file với dynamic field
...
export class SocketGateway {
  ...
  send${capitalizedModuleName}Update(): { success: boolean; error?: string } {
    try {
      // Phát sự kiện dynamic với tên: ${lowerCaseModuleName}updated
...
// Thêm file *.prisma* với template sử dụng dynamic field
...
// Định nghĩa các file cần tạo trong thư mục dynamic (dưới thư mục baseDir)
const files = {
  ...
  // File *.prisma* được tạo với tên dynamic (ví dụ: userguide.prisma, sanpham.prisma,...)
  [`${lowerCaseModuleName}.prisma`]: prismaTemplate,
};
