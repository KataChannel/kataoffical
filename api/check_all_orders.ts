...
async function main() {
  const masp = 'I100027'; // Bông điên điển
  ...
  orders.forEach((o) => {
    ...
    console.log(
      `${ngaygiaoStr.padEnd(10)} | ${o.donhang.madonhang.padEnd(12)} | ${o.donhang.status.padEnd(10)} | Active: ${String(o.donhang.isActive).padEnd(5)} | ${khName.padEnd(30)} | SL: ${o.sldat}`
    );
  });
}
