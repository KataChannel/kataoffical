...
export const routes: Routes = [
    { path: '', redirectTo: 'admin/welcome', pathMatch: 'full' },
    {
      path: '404',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          loadComponent: () => import('./admin/menu/listmenu/listmenu.component').then((c) => c.ListMenuComponent),
          children: [
            {
              path: '',
              loadComponent: () => import('./admin/menu/listmenu/listmenu.component').then((c) => c.ListMenuComponent),
            ...
            {
              path: ':id',
              loadComponent: () => import('./admin/menu/detailmenu/detailmenu.component').then((c) => c.DetailMenuComponent),
            },
          ],
        },
        {
