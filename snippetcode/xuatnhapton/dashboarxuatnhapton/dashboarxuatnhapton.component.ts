...
@Component({
  selector: 'app-dashboarxuatnhapton',
  imports: [
    DashboardblockComponent,
    RevenuechartComponent
  ],
  templateUrl: './dashboarxuatnhapton.component.html',
  styleUrl: './dashboarxuatnhapton.component.scss'
})
export class DashboarxuatnhaptonComponent {
