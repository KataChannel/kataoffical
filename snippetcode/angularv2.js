...
export class SanphamService {
  ...
  async getAllSanpham(pageSize: number = this.pageSize(), forceRefresh: boolean = false, queryParams: any = {}) {
...
import { SearchfilterComponent } from '../../../shared/common/searchfilter/searchfilter';
import { memoize, Debounce } from '../../../shared/utils/decorators';
@Component({
  selector: 'app-listsanpham',
  templateUrl: './listsanpham.html',
  styleUrls: ['./listsanpham.scss'],
  imports: [
    MatFormFieldModule,
    MatInputModule,
    MatTableModule,
