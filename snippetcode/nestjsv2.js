...
export class DonhangController { // Controller for Donhang
  ...
  @Post()
  @Audit({ entity: 'Donhang', action: AuditAction.CREATE, includeResponse: true })
  ...
  @Patch(':id')
  @Audit({ entity: 'Donhang', action: AuditAction.UPDATE, includeResponse: true })
  ...
  @UseGuards(JwtAuthGuard)
  @Delete(':id')
  @Audit({ entity: 'Donhang', action: AuditAction.DELETE })
...
const fileDefinitions = [
    ...
    {
        originalPath: "donhang/donhang.prisma",
        content: donhangPrismaContent,
    }
];
