import {
  CancelOrderService
} from "./chunk-O7I73GCY.js";
import {
  TrangThaiDon
} from "./chunk-T6TCKYMX.js";
import {
  KhoService
} from "./chunk-JEK27XAQ.js";
import {
  BanggiaService
} from "./chunk-WDJTPBJI.js";
import {
  DathangService
} from "./chunk-EVBPRNA2.js";
import {
  NhacungcapService
} from "./chunk-FJBGIWGZ.js";
import {
  SanphamService
...
var _c7 = (a0, a1) => ({ "text-green-600 font-semibold": a0, "text-yellow-600 font-semibold": a1 });
...
function ListDathangComponent_Conditional_42_button_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 59);
    \u0275\u0275listener("click", function ListDathangComponent_Conditional_42_button_0_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext(2);
      const DeleteDialog_r7 = \u0275\u0275reference(100);
...
function ListDathangComponent_Conditional_42_button_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 60);
    \u0275\u0275listener("click", function ListDathangComponent_Conditional_42_button_1_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext(2);
...
function ListDathangComponent_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListDathangComponent_Conditional_42_button_0_Template, 5, 0, "button", 57)(1, ListDathangComponent_Conditional_42_button_1_Template, 3, 0, "button", 58);
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
function ListDathangComponent_For_64_th_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 63)(1, "span", 64);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ListDathangComponent_For_64_td_2_Case_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_For_64_td_2_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 72);
    \u0275\u0275listener("click", function ListDathangComponent_For_64_td_2_Case_2_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r11);
...
function ListDathangComponent_For_64_td_2_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 66);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListDathangComponent_For_64_td_2_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 66);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListDathangComponent_For_64_td_2_Case_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_For_64_td_2_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 68);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function ListDathangComponent_For_64_td_2_Case_7_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const column_r9 = \u0275\u0275nextContext().$implicit;
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction5(2, _c5, row_r12[column_r9] === "dadat", row_r12[column_r9] === "dagiao", row_r12[column_r9] === "danhan", row_r12[column_r9] === "hoanthanh", row_r12[column_r9] === "huy"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r4.Trangthaidon[row_r12[column_r9]], " ");
  }
}
function ListDathangComponent_For_64_td_2_Case_8_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_For_64_td_2_Case_8_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_For_64_td_2_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 66);
    \u0275\u0275template(1, ListDathangComponent_For_64_td_2_Case_8_Conditional_1_Template, 2, 0, "mat-icon", 73)(2, ListDathangComponent_For_64_td_2_Case_8_Conditional_2_Template, 2, 0, "mat-icon", 74);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r12 = \u0275\u0275nextContext().$implicit;
...
function ListDathangComponent_For_64_td_2_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 68);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function ListDathangComponent_For_64_td_2_Case_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 75);
    \u0275\u0275listener("click", function ListDathangComponent_For_64_td_2_Case_10_Template_div_click_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(1, "button", 76);
    \u0275\u0275listener("click", function ListDathangComponent_For_64_td_2_Case_10_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r13);
      const row_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
...
function ListDathangComponent_For_64_td_2_Case_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const row_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c6, row_r12.status === "huy" || row_r12.status === "dahuy"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r12.lydohuy || "-", " ");
  }
}
function ListDathangComponent_For_64_td_2_Case_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 66);
  }
}
function ListDathangComponent_For_64_td_2_Case_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 66);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListDathangComponent_For_64_td_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 65);
    \u0275\u0275template(1, ListDathangComponent_For_64_td_2_Case_1_Template, 2, 1, "span", 66)(2, ListDathangComponent_For_64_td_2_Case_2_Template, 2, 1, "span", 67)(3, ListDathangComponent_For_64_td_2_Case_3_Template, 2, 1, "span", 66)(4, ListDathangComponent_For_64_td_2_Case_4_Template, 2, 2, "span", 66)(5, ListDathangComponent_For_64_td_2_Case_5_Template, 3, 4, "span", 68)(6, ListDathangComponent_For_64_td_2_Case_6_Template, 3, 4, "span", 68)(7, ListDathangComponent_For_64_td_2_Case_7_Template, 2, 8, "span", 69)(8, ListDathangComponent_For_64_td_2_Case_8_Template, 3, 1, "span", 66)(9, ListDathangComponent_For_64_td_2_Case_9_Template, 3, 4, "span", 68)(10, ListDathangComponent_For_64_td_2_Case_10_Template, 4, 2, "div", 70)(11, ListDathangComponent_For_64_td_2_Case_11_Template, 2, 4, "span", 71)(12, ListDathangComponent_For_64_td_2_Case_12_Template, 1, 0, "span", 66)(13, ListDathangComponent_For_64_td_2_Case_13_Template, 2, 1, "span", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_25_0;
...
function ListDathangComponent_For_64_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 42);
    \u0275\u0275template(1, ListDathangComponent_For_64_th_1_Template, 3, 1, "th", 61)(2, ListDathangComponent_For_64_td_2_Template, 14, 1, "td", 62);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_tr_65_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 77);
  }
}
function ListDathangComponent_tr_66_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 78);
    \u0275\u0275listener("click", function ListDathangComponent_tr_66_Template_tr_click_0_listener() {
...
function ListDathangComponent_tr_67_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_ng_template_99_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 81)(2, "div", 82);
...
function ListDathangComponent_ng_template_101_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 81)(2, "div", 82);
    \u0275\u0275text(3, "X\xE1c Nh\u1EADn");
    \u0275\u0275elementEnd();
...
function ListDathangComponent_ng_template_103_tr_30_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275text(0);
    \u0275\u0275elementStart(1, "button", 111);
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_103_tr_30_Conditional_2_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r18);
...
function ListDathangComponent_ng_template_103_tr_30_Conditional_4_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 117);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_103_tr_30_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 31)(1, "mat-label");
    \u0275\u0275text(2, "Nh\xE0 Cung C\u1EA5p");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-select", 112);
    \u0275\u0275listener("selectionChange", function ListDathangComponent_ng_template_103_tr_30_Conditional_4_Template_mat_select_selectionChange_3_listener($event) {
      \u0275\u0275restoreView(_r21);
      const detail_r19 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.SelectNhacungcap(detail_r19, $event));
    });
    \u0275\u0275elementStart(4, "div", 113)(5, "mat-form-field", 114)(6, "input", 115);
    \u0275\u0275listener("input", function ListDathangComponent_ng_template_103_tr_30_Conditional_4_Template_input_input_6_listener($event) {
      \u0275\u0275restoreView(_r21);
      const i_r20 = \u0275\u0275nextContext().index;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275repeaterCreate(8, ListDathangComponent_ng_template_103_tr_30_Conditional_4_For_9_Template, 2, 2, "mat-option", 117, _forTrack1);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const i_r20 = \u0275\u0275nextContext().index;
...
function ListDathangComponent_ng_template_103_tr_30_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-form-field", 31)(1, "mat-label");
    \u0275\u0275text(2, "Ng\xE0y Nh\u1EADn ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 118);
    \u0275\u0275listener("dateChange", function ListDathangComponent_ng_template_103_tr_30_Conditional_6_Template_input_dateChange_3_listener($event) {
      \u0275\u0275restoreView(_r23);
      const detail_r19 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "mat-datepicker-toggle", 39)(5, "mat-datepicker", null, 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_103_tr_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 104);
    \u0275\u0275template(2, ListDathangComponent_ng_template_103_tr_30_Conditional_2_Template, 4, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 105);
    \u0275\u0275template(4, ListDathangComponent_ng_template_103_tr_30_Conditional_4_Template, 10, 0, "mat-form-field", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 106);
    \u0275\u0275template(6, ListDathangComponent_ng_template_103_tr_30_Conditional_6_Template, 7, 3, "mat-form-field", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 107);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 107);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 108)(12, "span", 109);
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(8, _c7, detail_r19.status === "Processed" || detail_r19.status === "Success", detail_r19.status === "Skipped"));
    \u0275\u0275advance();
...
function ListDathangComponent_ng_template_103_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "h2", 86);
    \u0275\u0275text(1, "Import \u0110\u1EB7t H\xE0ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "mat-dialog-content", 87)(3, "div", 88)(4, "div", 89)(5, "table", 90)(6, "thead", 91)(7, "tr")(8, "th", 92);
    \u0275\u0275text(9, " # ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "th", 93);
    \u0275\u0275text(11, " Nh\xE0 Cung C\u1EA5p ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th", 94);
    \u0275\u0275text(13, " Ng\xE0y Nh\u1EADn ");
    \u0275\u0275elementStart(14, "mat-form-field", 52)(15, "mat-label");
    \u0275\u0275text(16, "Ng\xE0y Nh\u1EADn All ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "input", 95);
    \u0275\u0275listener("dateChange", function ListDathangComponent_ng_template_103_Template_input_dateChange_17_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.DoChonNgaynhan($event, "All"));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(18, "mat-datepicker-toggle", 39)(19, "mat-datepicker", null, 12);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "th", 97);
    \u0275\u0275text(26, " Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "th", 98);
    \u0275\u0275text(28, " Message");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "tbody", 99);
    \u0275\u0275template(30, ListDathangComponent_ng_template_103_tr_30_Template, 16, 11, "tr", 100);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(31, "mat-dialog-actions", 101)(32, "button", 102);
    \u0275\u0275text(33, "\u0110\xF3ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "button", 103);
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_103_Template_button_click_34_listener() {
      \u0275\u0275restoreView(_r17);
      const ctx_r4 = \u0275\u0275nextContext();
...
function ListDathangComponent_ng_template_105_For_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 130);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_105_For_32_For_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 130);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListDathangComponent_ng_template_105_For_32_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 147)(1, "span", 153);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-chip", 154);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_105_For_32_For_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 152)(1, "td", 155);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 156);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "td", 155);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 155);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 157);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 155);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td", 155);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td", 158);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const sp_r31 = ctx.$implicit;
    const \u0275$index_577_r32 = ctx.$index;
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275$index_577_r32 + 1);
    \u0275\u0275advance(2);
...
function ListDathangComponent_ng_template_105_For_32_ForEmpty_51_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_ng_template_105_For_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r28 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 133)(1, "div", 140)(2, "div", 141)(3, "mat-checkbox", 142);
    \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_ng_template_105_For_32_Template_mat_checkbox_ngModelChange_3_listener($event) {
    ...
    \u0275\u0275listener("change", function ListDathangComponent_ng_template_105_For_32_Template_mat_checkbox_change_3_listener() {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.toggleOrderConfirmation(order_r29));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "h3", 143);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p", 137);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "button", 144);
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_105_For_32_Template_button_click_9_listener() {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(11, "delete");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 145)(13, "mat-form-field", 52)(14, "mat-label");
    \u0275\u0275text(15, "Ng\xE0y nh\u1EADn");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 127);
    \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_ng_template_105_For_32_Template_input_ngModelChange_16_listener($event) {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      \u0275\u0275twoWayBindingSet(order_r29.configOptions.selectedDate, $event) || (order_r29.configOptions.selectedDate = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("dateChange", function ListDathangComponent_ng_template_105_For_32_Template_input_dateChange_16_listener($event) {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.updateOrderDate(order_r29, $event.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(17, "mat-datepicker-toggle", 39)(18, "mat-datepicker", null, 14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 146)(21, "mat-form-field", 52)(22, "mat-label");
    \u0275\u0275text(23, "Kho");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "mat-select", 129);
    \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_ng_template_105_For_32_Template_mat_select_ngModelChange_24_listener($event) {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      \u0275\u0275twoWayBindingSet(order_r29.khoSelected, $event) || (order_r29.khoSelected = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("selectionChange", function ListDathangComponent_ng_template_105_For_32_Template_mat_select_selectionChange_24_listener($event) {
      const order_r29 = \u0275\u0275restoreView(_r28).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.updateOrderKhoSelection(order_r29, $event.value));
    });
    \u0275\u0275repeaterCreate(25, ListDathangComponent_ng_template_105_For_32_For_26_Template, 2, 3, "mat-option", 130, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(27, ListDathangComponent_ng_template_105_For_32_Conditional_27_Template, 5, 3, "div", 147);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 89)(29, "table", 148)(30, "thead", 149)(31, "tr")(32, "th", 150);
    \u0275\u0275text(33, "STT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "th", 150);
    \u0275\u0275text(35, "M\xE3 SP");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "th", 150);
    \u0275\u0275text(37, "T\xEAn s\u1EA3n ph\u1EA9m");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "th", 150);
    \u0275\u0275text(39, "\u0110VT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "th", 150);
    \u0275\u0275text(41, "SL \u0110\u1EB7t");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "th", 150);
    \u0275\u0275text(43, "SL Giao");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "th", 150);
    \u0275\u0275text(45, "SL Nh\u1EADn");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "th", 150);
    \u0275\u0275text(47, "Ghi ch\xFA");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(48, "tbody", 151);
    \u0275\u0275repeaterCreate(49, ListDathangComponent_ng_template_105_For_32_For_50_Template, 17, 8, "tr", 152, _forTrack2, false, ListDathangComponent_ng_template_105_For_32_ForEmpty_51_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_105_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 134)(1, "div", 160);
...
function ListDathangComponent_ng_template_105_Template(rf, ctx) {
  if (rf & 1) {
    const _r26 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "h2", 119)(1, "span");
    \u0275\u0275text(2, "Import \u0110\u1EB7t H\xE0ng t\u1EEB Excel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 120)(4, "span");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "span", 121);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "mat-dialog-content", 122)(9, "div", 123)(10, "div", 124)(11, "div", 125)(12, "mat-form-field", 126)(13, "mat-label");
    \u0275\u0275text(14, "Ng\xE0y nh\u1EADn (T\u1EA5t c\u1EA3)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "input", 127);
    \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_ng_template_105_Template_input_ngModelChange_15_listener($event) {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.ImportConfig.selectedDate, $event) || (ctx_r4.ImportConfig.selectedDate = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("dateChange", function ListDathangComponent_ng_template_105_Template_input_dateChange_15_listener($event) {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.updateAllOrdersDate($event.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(16, "mat-datepicker-toggle", 39)(17, "mat-datepicker", null, 13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "mat-form-field", 128)(20, "mat-label");
    \u0275\u0275text(21, "Kho (T\u1EA5t c\u1EA3)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-select", 129);
    \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_ng_template_105_Template_mat_select_ngModelChange_22_listener($event) {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.ImportConfig.selectedKho, $event) || (ctx_r4.ImportConfig.selectedKho = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("selectionChange", function ListDathangComponent_ng_template_105_Template_mat_select_selectionChange_22_listener($event) {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.updateAllOrdersKho($event.value));
    });
    \u0275\u0275repeaterCreate(23, ListDathangComponent_ng_template_105_For_24_Template, 2, 3, "mat-option", 130, _forTrack1);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "button", 103);
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_105_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "div", 131)(30, "div", 132);
    \u0275\u0275repeaterCreate(31, ListDathangComponent_ng_template_105_For_32_Template, 52, 12, "div", 133, _forTrack1);
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, ListDathangComponent_ng_template_105_Conditional_33_Template, 5, 0, "div", 134);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "mat-dialog-actions", 135)(35, "div", 136)(36, "div", 137);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "div", 138)(39, "button", 85);
    \u0275\u0275text(40, "\u0110\xF3ng");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "button", 139);
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_105_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r26);
      const ctx_r4 = \u0275\u0275nextContext();
...
function ListDathangComponent_ng_template_107_For_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 176)(1, "div", 180);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_107_For_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 181)(1, "div", 182);
    \u0275\u0275text(2, "SL \u0111\u1EB7t");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "th", 181)(4, "div", 182);
    \u0275\u0275text(5, "Gi\xE1 nh\u1EADp");
    \u0275\u0275elementEnd()();
  }
}
function ListDathangComponent_ng_template_107_For_44_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 183);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_107_For_44_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 184);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_107_For_44_For_6_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_ng_template_107_For_44_For_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_ng_template_107_For_44_For_6_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ListDathangComponent_ng_template_107_For_44_For_6_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 161);
    \u0275\u0275text(1, "-");
    \u0275\u0275elementEnd();
...
function ListDathangComponent_ng_template_107_For_44_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 186);
    \u0275\u0275template(1, ListDathangComponent_ng_template_107_For_44_For_6_Conditional_1_Template, 3, 4, "span", 187)(2, ListDathangComponent_ng_template_107_For_44_For_6_Conditional_2_Template, 2, 0, "span", 161);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td", 186);
    \u0275\u0275template(4, ListDathangComponent_ng_template_107_For_44_For_6_Conditional_4_Template, 3, 4, "span", 188)(5, ListDathangComponent_ng_template_107_For_44_For_6_Conditional_5_Template, 2, 0, "span", 161);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_107_For_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 152);
    \u0275\u0275template(1, ListDathangComponent_ng_template_107_For_44_Conditional_1_Template, 2, 2, "td", 183)(2, ListDathangComponent_ng_template_107_For_44_Conditional_2_Template, 2, 2, "td", 184);
    \u0275\u0275elementStart(3, "td", 185);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(5, ListDathangComponent_ng_template_107_For_44_For_6_Template, 6, 2, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ListDathangComponent_ng_template_107_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 177)(1, "mat-icon", 189);
    \u0275\u0275text(2, "inventory_2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 190);
    \u0275\u0275text(4, "Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 191);
    \u0275\u0275text(6, "Vui l\xF2ng ch\u1ECDn kho\u1EA3ng th\u1EDDi gian kh\xE1c");
    \u0275\u0275elementEnd()();
  }
}
function ListDathangComponent_ng_template_107_Template(rf, ctx) {
  if (rf & 1) {
    const _r35 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 162)(1, "div")(2, "h2", 163);
    ...
    \u0275\u0275pipe(7, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "button", 165)(9, "mat-icon");
    \u0275\u0275text(10, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(11, "mat-dialog-content", 166)(12, "div", 167)(13, "div", 168)(14, "div", 169);
    \u0275\u0275text(15, " Hi\u1EC3n th\u1ECB ");
    ...
    \u0275\u0275listener("click", function ListDathangComponent_ng_template_107_Template_button_click_22_listener() {
      \u0275\u0275restoreView(_r35);
      const ctx_r4 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(27, "div", 170)(28, "table", 171)(29, "thead", 172)(30, "tr")(31, "th", 173);
    \u0275\u0275text(32, "M\xE3 SP");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "th", 174);
    \u0275\u0275text(34, "T\xEAn SP");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "th", 175);
    \u0275\u0275text(36, "T\xEAn NCC");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(37, ListDathangComponent_ng_template_107_For_38_Template, 3, 1, "th", 176, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "tr");
    \u0275\u0275repeaterCreate(40, ListDathangComponent_ng_template_107_For_41_Template, 6, 0, null, null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "tbody");
    \u0275\u0275repeaterCreate(43, ListDathangComponent_ng_template_107_For_44_Template, 7, 3, "tr", 152, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(45, ListDathangComponent_ng_template_107_Conditional_45_Template, 7, 0, "div", 177);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "mat-dialog-actions", 178)(47, "button", 179);
    \u0275\u0275text(48, "\u0110\xF3ng");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var ListDathangComponent = class _ListDathangComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListDathangComponent, selectors: [["app-listdathang"]], viewQuery: function ListDathangComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 17)(5, "div", 18)(6, "div", 19)(7, "div", 20)(8, "input", 21);
      ...
      \u0275\u0275text(16, "T\u1EA1o M\u1EDBi");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "div", 19)(18, "button", 26);
      ...
      \u0275\u0275text(25, "download");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(26, "button", 29)(27, "mat-icon");
      \u0275\u0275text(28, "tune");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(29, "mat-menu", null, 2)(31, "div", 30)(32, "mat-form-field", 31)(33, "input", 32);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "mat-icon", 33);
      \u0275\u0275text(35, "search");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(36, "div", 34);
      \u0275\u0275repeaterCreate(37, ListDathangComponent_For_38_Template, 5, 2, "button", 35, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(39, "button", 36);
      \u0275\u0275listener("click", function ListDathangComponent_Template_button_click_39_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(41, "compare");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(42, ListDathangComponent_Conditional_42_Template, 2, 2);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "div", 19)(44, "mat-form-field", 37)(45, "mat-label");
      \u0275\u0275text(46, "B\u1EAFt \u0110\u1EA7u");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "input", 38);
      \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_Template_input_ngModelChange_47_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.searchParam.Batdau, $event) || (ctx.searchParam.Batdau = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(48, "mat-datepicker-toggle", 39)(49, "mat-datepicker", null, 3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "mat-form-field", 37)(52, "mat-label");
      \u0275\u0275text(53, "K\u1EBFt Th\xFAc");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(54, "input", 38);
      \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_Template_input_ngModelChange_54_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.searchParam.Ketthuc, $event) || (ctx.searchParam.Ketthuc = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(55, "mat-datepicker-toggle", 39)(56, "mat-datepicker", null, 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "button", 28);
      \u0275\u0275listener("click", function ListDathangComponent_Template_button_click_58_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(60, "search");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(61, "div", 40)(62, "table", 41);
      \u0275\u0275repeaterCreate(63, ListDathangComponent_For_64_Template, 3, 1, "ng-container", 42, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275template(65, ListDathangComponent_tr_65_Template, 1, 0, "tr", 43)(66, ListDathangComponent_tr_66_Template, 1, 3, "tr", 44)(67, ListDathangComponent_tr_67_Template, 3, 0, "tr", 45);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(68, "div", 46)(69, "div", 47)(70, "span", 48);
      \u0275\u0275text(71, "\u0110ang Xem ");
      ...
      \u0275\u0275text(77);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(78, "div", 49)(79, "span", 50, 5);
      \u0275\u0275text(81);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(82, "mat-menu", null, 6)(84, "div", 51);
      \u0275\u0275listener("click", function ListDathangComponent_Template_div_click_84_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView($event.stopPropagation());
      });
      \u0275\u0275elementStart(85, "mat-form-field", 52)(86, "mat-label");
      \u0275\u0275text(87, "S\u1ED1 l\u01B0\u1EE3ng");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(88, "input", 53);
      \u0275\u0275twoWayListener("ngModelChange", function ListDathangComponent_Template_input_ngModelChange_88_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ListDathangComponent_Template_button_click_89_listener() {
        \u0275\u0275restoreView(_r1);
        const menuHienthi_r16 = \u0275\u0275reference(80);
        return \u0275\u0275resetView(ctx.onPageSizeChange(ctx.pageSize(), menuHienthi_r16));
      });
      \u0275\u0275elementStart(90, "mat-icon");
      \u0275\u0275text(91, "published_with_changes");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(92, "div", 54)(93, "button", 55);
      ...
      \u0275\u0275text(95, "keyboard_arrow_left");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(96, "button", 55);
      \u0275\u0275listener("click", function ListDathangComponent_Template_button_click_96_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onNextPage());
      });
      \u0275\u0275elementStart(97, "mat-icon");
      \u0275\u0275text(98, "keyboard_arrow_right");
      \u0275\u0275elementEnd()()()()()()()();
      \u0275\u0275template(99, ListDathangComponent_ng_template_99_Template, 11, 0, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(101, ListDathangComponent_ng_template_101_Template, 11, 0, "ng-template", null, 8, \u0275\u0275templateRefExtractor)(103, ListDathangComponent_ng_template_103_Template, 36, 3, "ng-template", null, 9, \u0275\u0275templateRefExtractor)(105, ListDathangComponent_ng_template_105_Template, 43, 14, "ng-template", null, 10, \u0275\u0275templateRefExtractor)(107, ListDathangComponent_ng_template_107_Template, 49, 12, "ng-template", null, 11, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const menu_r39 = \u0275\u0275reference(30);
      const pickerBatdau_r40 = \u0275\u0275reference(50);
      const pickerKetthuc_r41 = \u0275\u0275reference(57);
      const menu1_r42 = \u0275\u0275reference(83);
      \u0275\u0275advance();
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.EditList.length > 0 ? 42 : -1);
      \u0275\u0275advance(2);
      ...
      \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(29, _c4));
      \u0275\u0275advance();
      ...
      \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(30, _c4));
      \u0275\u0275advance();
      ...
      \u0275\u0275property("ngModelOptions", \u0275\u0275pureFunction0(31, _c4));
      \u0275\u0275advance(5);
...
//# sourceMappingURL=chunk-EAZU7JEI.js.map
