...
var nhanvienRoutes = [
  ...
  __spreadValues({
    path: "list",
    loadComponent: () => import("./chunk-SERVLTUL.js").then((m) => m.ListNhanvienComponent),
    data: {
  ...
  __spreadValues({
    path: "create",
    loadComponent: () => import("./chunk-QTLTTOFN.js").then((m) => m.FormNhanvienComponent),
    data: {
  ...
  __spreadValues({
    path: "detail/:id",
    loadComponent: () => import("./chunk-LENWTEL2.js").then((m) => m.DetailNhanvienComponent),
    data: {
...
//# sourceMappingURL=chunk-QOPAHKTY.js.map
