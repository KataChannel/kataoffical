import {
  UserguideService
} from "./chunk-YKALLHPG.js";
import {
  MenuService
} from "./chunk-MCGMTXJX.js";
import {
  ErrorLogService
...
import {
  MatCheckbox,
  MatCheckboxModule
} from "./chunk-LJBSGEZI.js";
import {
  MatTab,
  MatTabGroup,
  MatTabsModule
} from "./chunk-E2L2AYIP.js";
import {
  GraphqlService
...
var AdminmainComponent = class _AdminmainComponent {
  ...
  constructor(_breakpointObserver, _UserService, _ErrorLogService) {
  ...
  static \u0275fac = function AdminmainComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AdminmainComponent)(\u0275\u0275directiveInject(BreakpointObserver), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(ErrorLogService));
  };
  ...
  }, decls: 105, vars: 19, consts: [["drawer", ""], ["search", ""], ["menu", "matMenu"], ["menu1", "matMenu"], ["drawer1", ""], ["autosize", "", 1, "!w-screen", "!h-screen"], ["mode", "side", "position", "start", 1, ""], [1, "relative", "h-full", "flex", "flex-col", "space-y-2", "!bg-[#0B9444]", "!text-white"], [1, "relative", "flex", "flex-col", "space-y-2", "p-2"], ["alt", "Logo", 1, "h-20", "object-contain", "rounded-lg", "bg-white", "p-2", 3, "src"], [1, "relative", "flex", "flex-col", "space-y-2", "h-full", "overflow-auto", "p-2"], [1, "relative", "w-full"], ["type", "text", "placeholder", "T\xECm Ki\u1EBFm...", 1, "block", "w-full", "pl-10", "pr-4", "py-2", "text-gray-700", "bg-white", "border", "border-gray-300", "rounded-lg", "focus:border-blue-400", "focus:ring-blue-400", "focus:outline-none", "focus:ring", "focus:ring-opacity-40", 3, "input"], [1, "absolute", "inset-y-0", "left-0", "flex", "items-center", "pl-3", "pointer-events-none"], [1, "material-symbols-outlined", "text-gray-500"], [3, "ListMenu"], [1, "relative", "w-full", "justify-between", "flex", "flex-row", "space-x-2", "items-center", "p-2"], [1, "flex", "flex-row", "space-x-2"], ["alt", "Avatar", 1, "max-w-14", "max-h-14", "object-cover", "rounded-full", 3, "src"], [1, "flex", "flex-col"], [1, "font-bold"], [1, "italic", "text-xs"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["mat-menu-item", "", 3, "routerLink"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"], [1, "relative", "flex", "flex-col", "w-full", "h-full", "primary"], [1, "relative", "flex", "flex-row", "space-x-2", "justify-between", "items-center", "p-1", "bg-[#57A345]"], [1, "flex", "flex-row", "space-x-2", "items-center"], ["mat-icon-button", "", 3, "click"], [1, "relative", "max-w-xl", "flex", "flex-row", "items-center", "search-input-container", 3, "click"], ["type", "text", "placeholder", "T\xECm Ki\u1EBFm...", "readonly", "", 1, "block", "w-full", "pl-10", "pr-4", "py-2", "text-gray-700", "bg-white", "border", "border-gray-300", "rounded-lg", "focus:border-blue-400", "focus:ring-blue-400", "focus:outline-none", "focus:ring", "focus:ring-opacity-40"], ["mat-icon-button", "", 3, "routerLink"], [1, "flex", "flex-row", "space-x-2", "items-center", "p-4"], ["mat-menu-item", "", 3, "href"], ["mode", "over", "position", "end", 1, "!w-screen", "lg:!w-1/2"], [1, "relative", "h-full", "flex", "flex-col", "space-y-2", "p-2"], [1, "relative", "flex", "w-full", "overflow-auto"]], template: function AdminmainComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      ...
      \u0275\u0275listener("click", function AdminmainComponent_Template_div_click_55_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function AdminmainComponent_Template_button_click_61_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function AdminmainComponent_Template_button_click_64_listener() {
        \u0275\u0275restoreView(_r1);
        const drawer1_r3 = \u0275\u0275reference(95);
        drawer1_r3.toggle();
      ...
      \u0275\u0275listener("click", function AdminmainComponent_Template_button_click_67_listener() {
        \u0275\u0275restoreView(_r1);
        const drawer1_r3 = \u0275\u0275reference(95);
        return \u0275\u0275resetView(drawer1_r3.toggle());
      });
      \u0275\u0275elementStart(68, "mat-icon");
      \u0275\u0275text(69, "notifications");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(70, "a", 32)(71, "mat-icon");
      \u0275\u0275text(72, "chat");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(73, "button", 22)(74, "mat-icon");
      \u0275\u0275text(75, "account_circle");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(76, "mat-menu", null, 3)(78, "div", 33);
      \u0275\u0275element(79, "img", 18);
      \u0275\u0275elementStart(80, "div", 19)(81, "div", 20);
      \u0275\u0275text(82);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(86);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(87, "a", 34);
      \u0275\u0275text(88, "Th\xF4ng Tin");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(89, "button", 24);
      \u0275\u0275text(90, "C\xE0i \u0110\u1EB7t");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(91, "button", 25);
      \u0275\u0275listener("click", function AdminmainComponent_Template_button_click_91_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.logout());
      });
      \u0275\u0275text(92, "\u0110\u0103ng Xu\u1EA5t");
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(94, "mat-drawer", 35, 4)(96, "div", 36)(97, "div", 28)(98, "button", 29);
      ...
      \u0275\u0275text(100, "arrow_back");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(101, "span", 20);
      \u0275\u0275text(102, "Quy Tr\xECnh");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(103, "div", 37);
      \u0275\u0275text(104, " Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u ");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      const menu_r4 = \u0275\u0275reference(28);
      const menu1_r5 = \u0275\u0275reference(77);
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(16, _c22));
      \u0275\u0275advance(5);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(17, _c32));
      \u0275\u0275advance(36);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(18, _c4));
      \u0275\u0275advance(3);
      \u0275\u0275property("matMenuTriggerFor", menu1_r5);
      \u0275\u0275advance(6);
      \u0275\u0275property("src", ctx.User == null ? null : ctx.User.Avatar, \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.User == null ? null : ctx.User.Hoten);
      ...
      \u0275\u0275textInterpolate(ctx.User == null ? null : ctx.User.email);
      \u0275\u0275advance();
      \u0275\u0275property("href", "/admin/profile", \u0275\u0275sanitizeUrl);
    }
  }, dependencies: [
    MatTreeModule,
    MatSidenavModule,
