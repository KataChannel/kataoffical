...
var printDocASTReducer = {
  ...
  VariableDefinition: {
    leave: ({
      ...
      defaultValue,
      directives
    }) => variable + ": " + type + wrap3(" = ", defaultValue) + wrap3(" ", join(directives, " "))
  },
  SelectionSet: {
    leave: ({
      selections
  ...
  InlineFragment: {
    leave: ({
      ...
      directives,
      selectionSet
    }) => join(["...", wrap3("on ", typeCondition), join(directives, " "), selectionSet], " ")
  },
  FragmentDefinition: {
    leave: ({
      name,
  ...
  ObjectTypeDefinition: {
    leave: ({
      ...
      directives,
      fields
    }) => wrap3("", description, "\n") + join(["type", name, wrap3("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ")
  },
  FieldDefinition: {
    leave: ({
      description,
  ...
  InputValueDefinition: {
    leave: ({
      ...
      defaultValue,
      directives
    }) => wrap3("", description, "\n") + join([name + ": " + type, wrap3("= ", defaultValue), join(directives, " ")], " ")
  },
  InterfaceTypeDefinition: {
    leave: ({
      description,
      ...
      directives,
      fields
    }) => wrap3("", description, "\n") + join(["interface", name, wrap3("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ")
  },
  UnionTypeDefinition: {
    leave: ({
      description,
      ...
      directives,
      types
    }) => wrap3("", description, "\n") + join(["union", name, join(directives, " "), wrap3("= ", join(types, " | "))], " ")
  },
  EnumTypeDefinition: {
    leave: ({
      description,
  ...
  ObjectTypeExtension: {
    leave: ({
      ...
      directives,
      fields
    }) => join(["extend type", name, wrap3("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ")
  },
  InterfaceTypeExtension: {
    leave: ({
      name,
      ...
      directives,
      fields
    }) => join(["extend interface", name, wrap3("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ")
  },
  UnionTypeExtension: {
    leave: ({
      name,
      directives,
      types
    }) => join(["extend union", name, join(directives, " "), wrap3("= ", join(types, " | "))], " ")
  },
  EnumTypeExtension: {
    leave: ({
      name,
...
//# sourceMappingURL=chunk-4KYN7I6C.js.map
