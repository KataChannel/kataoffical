...
var nhanvienRoutes = [
  ...
  __spreadValues({
    path: "list",
    loadComponent: () => import("./chunk-WJEZLNLK.js").then((m) => m.ListNhanvienComponent),
    data: {
  ...
  __spreadValues({
    path: "create",
    loadComponent: () => import("./chunk-7A2NOJSZ.js").then((m) => m.FormNhanvienComponent),
    data: {
  ...
  __spreadValues({
    path: "detail/:id",
    loadComponent: () => import("./chunk-ITWJBAWH.js").then((m) => m.DetailNhanvienComponent),
    data: {
...
//# sourceMappingURL=chunk-SPUZKXJX.js.map
