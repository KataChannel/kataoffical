...
var phongbanRoutes = [
  ...
  __spreadValues({
    path: "list",
    loadComponent: () => import("./chunk-YPJNJNZ4.js").then((m) => m.ListPhongbanComponent),
    data: {
  ...
  __spreadValues({
    path: "create",
    loadComponent: () => import("./chunk-B7W5RRHF.js").then((m) => m.FormPhongbanComponent),
    data: {
  ...
  __spreadValues({
    path: "detail/:id",
    loadComponent: () => import("./chunk-RDMCHVCV.js").then((m) => m.DetailPhongbanComponent),
    data: {
...
//# sourceMappingURL=chunk-YNO7JP6X.js.map
