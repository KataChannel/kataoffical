import {
  FIREBASE_OPTIONS
} from "./chunk-7TMMATB6.js";
import "./chunk-7VZTPIES.js";
import "./chunk-7VBTZPN3.js";
...
var routes = [
  ...
  __spreadValues({
    path: "404",
    loadComponent: () => import("./chunk-UEDVNAXX.js").then((c) => c.NotfoundComponent)
  }, false ? { \u0275entryName: "src/app/site/notfound/notfound.component.ts" } : {}),
  __spreadValues({
    path: "admin",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-TRCFM6TU.js").then((c) => c.AdminmainComponent),
    children: [
      {
        path: "bulk-price-update",
        loadComponent: () => import("./chunk-XTRO3U5A.js").then((m) => m.BulkPriceUpdateComponent)
      },
      {
        path: "price-alerts",
        loadComponent: () => import("./chunk-4OOFG6SN.js").then((m) => m.PriceAlertsComponent)
      },
      {
        path: "price-analytics",
        loadComponent: () => import("./chunk-OUSIN62W.js").then((m) => m.PriceAnalyticsComponent)
      },
      {
        path: "price-comparison",
        loadComponent: () => import("./chunk-VIORVQWP.js").then((m) => m.PriceComparisonComponent)
      },
      {
        path: "auditlog",
        canActivate: [PermissionGuard],
        data: { permission: "auditlog.view" },
        loadChildren: () => import("./chunk-A4GLNCHI.js").then((m) => m.AuditlogRoutingModule)
      },
      {
        path: "performance",
        loadComponent: () => import("./chunk-YSCRY3KA.js").then((c) => c.PerformanceComponent)
      },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-F2XVSNFS.js").then((c) => c.DashboardComponent)
      },
      {
        path: "dashboard/baocaodoanhthu",
        loadComponent: () => import("./chunk-TIOF7ZIZ.js").then((c) => c.BaocaodoanhtuComponent)
      },
      {
        path: "thongke",
        loadChildren: () => import("./chunk-SF2MOBPU.js").then((m) => m.THONGKE_ROUTES)
      },
      {
        path: "testing",
        loadComponent: () => import("./chunk-5CMOGFR3.js").then((c) => c.TestingComponent)
      },
      {
        path: "performance",
        canActivate: [PermissionGuard],
      ...
      {
        path: "lienheadmin",
        loadComponent: () => import("./chunk-P3HEMF2D.js").then((c) => c.LienheadminComponent)
      },
      {
        path: "menu",
        canActivate: [PermissionGuard],
        data: { permission: "menu.view" },
        loadComponent: () => import("./chunk-FAOEHZTB.js").then((c) => c.ListMenuComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-FAOEHZTB.js").then((c) => c.ListMenuComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-VPTWMK4W.js").then((c) => c.DetailMenuComponent)
          }
        ]
      },
      {
        path: "hotro",
        loadComponent: () => import("./chunk-BKUA2TFQ.js").then((c) => c.ListHotroComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-OYOLLDY7.js").then((c) => c.DetailHotroComponent)
          }
        ]
      },
      {
        path: "support",
        loadComponent: () => import("./chunk-7AW3TUDA.js").then((c) => c.SupportListComponent)
      },
      {
        path: "support/new",
        loadComponent: () => import("./chunk-YGWH5EK7.js").then((c) => c.SupportCreateComponent)
      },
      {
        path: "support/:id",
        loadComponent: () => import("./chunk-4MQSBFP6.js").then((c) => c.SupportDetailComponent)
      },
      {
        path: "nhomuser",
        canActivate: [PermissionGuard],
        data: { permission: "nhomuser.view" },
        loadComponent: () => import("./chunk-WGE23YTI.js").then((c) => c.ListRoleComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-WGE23YTI.js").then((c) => c.ListRoleComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-ANEQNTZL.js").then((c) => c.DetailRoleComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-OTROARTK.js").then((c) => c.ListPermissionComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-OTROARTK.js").then((c) => c.ListPermissionComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-RSVWHMDU.js").then((c) => c.DetailPermissionComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-D7UTYFGW.js").then((c) => c.UserPermissionManagementComponent)
      },
      // {
      ...
      // },
      {
        ...
        loadChildren: () => import("./chunk-YOK66WVV.js").then((m) => m.phongbanRoutes)
      },
      {
        path: "nhanvien",
        canActivate: [PermissionGuard],
        data: { permission: "nhanvien.view" },
        loadChildren: () => import("./chunk-SPUZKXJX.js").then((m) => m.nhanvienRoutes)
      },
      {
        path: "importdata",
        canActivate: [PermissionGuard],
        data: { permission: "importdata.view" },
        loadChildren: () => import("./chunk-WIYQGUHX.js").then((m) => m.ImportdataRoutingModule)
      },
      {
        path: "danhmuc",
        loadComponent: () => import("./chunk-AHT6SAFY.js").then((c) => c.ListdanhmucComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-B4J5PFRS.js").then((c) => c.DetailDanhmucComponent)
          }
        ]
      },
      {
        path: "baiviet",
        loadComponent: () => import("./chunk-SFLWEU7P.js").then((c) => c.ListbaivietComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-FESZ4GN4.js").then((c) => c.DetailBaivietComponent)
          }
        ]
      },
      {
        path: "goooglesheets",
        loadComponent: () => import("./chunk-FOC2W2O2.js").then((c) => c.GooglesheetsComponent)
      },
      {
        path: "sanpham",
        canActivate: [PermissionGuard],
        data: { permission: "sanpham.view" },
        loadComponent: () => import("./chunk-CLDA7WKU.js").then((c) => c.ListSanphamComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-CLDA7WKU.js").then((c) => c.ListSanphamComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-ZLT6ZF7A.js").then((c) => c.DetailSanphamComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-J2WMZQJW.js").then((c) => c.ListBanggiaComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-J2WMZQJW.js").then((c) => c.ListBanggiaComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-6SWFHIPT.js").then((c) => c.DetailBanggiaComponent)
          }
        ]
      },
      {
        ...
        loadChildren: () => import("./chunk-TTYBJYQF.js").then((m) => m.KhachhangRoutingModule)
      },
      // {
      //   path: 'khachhang',
      //   canActivate: [PermissionGuard],
      ...
      // },
      {
        ...
        loadComponent: () => import("./chunk-LLGRJS6H.js").then((c) => c.ListNhomkhachhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-LLGRJS6H.js").then((c) => c.ListNhomkhachhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-GLZZDSKV.js").then((c) => c.DetailNhomkhachhangComponent)
          }
        ]
      },
      {
        ...
        loadChildren: () => import("./chunk-2BZSRNYG.js").then((m) => m.NhacungcapRoutingModule)
      },
      {
        path: "nhomncc",
        canActivate: [PermissionGuard],
        data: { permission: "nhomncc.view" },
        loadChildren: () => import("./chunk-DUSA73D4.js").then((m) => m.NhomnccRoutingModule)
      },
      {
        path: "dathang",
        canActivate: [PermissionGuard],
        data: { permission: "dathang.view" },
        loadComponent: () => import("./chunk-UZXVD2JJ.js").then((c) => c.ListDathangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-UZXVD2JJ.js").then((c) => c.ListDathangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-RZQEEDPR.js").then((c) => c.DetailDathangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-N3W4WLK3.js").then((c) => c.NhucaudathangComponent)
      },
      {
        path: "donhang",
        canActivate: [PermissionGuard],
        data: { permission: "donhang.view" },
        loadComponent: () => import("./chunk-ROWK4QDP.js").then((c) => c.ListDonhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-ROWK4QDP.js").then((c) => c.ListDonhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-EESR67TG.js").then((c) => c.DetailDonhangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-IIB4EKI4.js").then((c) => c.VandonComponent)
      },
      {
        path: "phieuchuyen",
        canActivate: [PermissionGuard],
        data: { permission: "phieuchuyen.view" },
        loadComponent: () => import("./chunk-JVIGVZII.js").then((c) => c.ListPhieuchuyenComponent)
      },
      {
        path: "kho",
        loadComponent: () => import("./chunk-FUOCLA2C.js").then((c) => c.ListKhoComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-FUOCLA2C.js").then((c) => c.ListKhoComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-4X64WRRA.js").then((c) => c.DetailKhoComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-4VOY444I.js").then((c) => c.ListPhieugiaohangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-4VOY444I.js").then((c) => c.ListPhieugiaohangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-4DUDBSK3.js").then((c) => c.DetailPhieugiaohangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-4GZG6UVV.js").then((c) => c.ListPhieuchiahangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-4GZG6UVV.js").then((c) => c.ListPhieuchiahangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-I6QHWBFC.js").then((c) => c.DetailPhieuchiahangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-GTUQAHZM.js").then((c) => c.ListPhieukhoComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-GTUQAHZM.js").then((c) => c.ListPhieukhoComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-C4LLYIEG.js").then((c) => c.DetailPhieukhoComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-BXDNHTU3.js").then((c) => c.XuatnhaptonComponent)
        // children: [
        //   {
        //     path: ':id',
        //     loadComponent: () =>
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-KYGRK3SF.js").then((m) => m.ChotkhoRoutingModule)
      },
      {
        path: "congnokhachhang",
        canActivate: [PermissionGuard],
        data: { permission: "congnokhachhang.view" },
        loadComponent: () => import("./chunk-5ZBNZH4N.js").then((c) => c.ListcongnokhachhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-5ZBNZH4N.js").then((c) => c.ListcongnokhachhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-3YK4JAEL.js").then((c) => c.DetailCongnokhachhangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-YQ5QMB7R.js").then((c) => c.ListUserguideComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-YQ5QMB7R.js").then((c) => c.ListUserguideComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-MDH67I3K.js").then((c) => c.DetailUserguideComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-IQ2Y2LPU.js").then((c) => c.ListcongnonccComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-IQ2Y2LPU.js").then((c) => c.ListcongnonccComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-Z3J2JYAW.js").then((c) => c.DetailCongnonccComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-AWIGZPGL.js").then((c) => c.ListUserComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-AWIGZPGL.js").then((c) => c.ListUserComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-X2RD3KWU.js").then((c) => c.DetailUserComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-PJDUXFAV.js").then((c) => c.ListquanlyfileComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-I7DV5BGF.js").then((c) => c.DetailQuanlyfileComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-G7TNE73W.js").then((c) => c.ProfileComponent),
        children: [
          {
            path: "socialpage",
            loadComponent: () => import("./chunk-BPML5BO2.js").then((c) => c.SocialComponent)
          }
        ]
      },
      {
      ...
      {
        path: "account",
        loadComponent: () => import("./chunk-OBRGK3CB.js").then((c) => c.AccountComponent),
        children: [
          {
            path: "password",
            loadComponent: () => import("./chunk-N3YBAW2R.js").then((c) => c.PasswordComponent)
          },
          {
            path: "general",
            loadComponent: () => import("./chunk-KSJ3OP77.js").then((c) => c.GeneralComponent)
          }
        ]
      }
    ]
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-ITSDMM7S.js").then((c) => c.LoginComponent)
  }, false ? { \u0275entryName: "src/app/shared/common/users/login/login.component.ts" } : {}),
  __spreadValues({
    path: "register",
    canActivate: [GuestGuard],
    canActivateChild: [GuestGuard],
    loadComponent: () => import("./chunk-LKZXCKYQ.js").then((c) => c.RegisterComponent)
  }, false ? { \u0275entryName: "src/app/shared/common/users/register/register.component.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-SRPKVXK3.js").then((c) => c.SitemainComponent),
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-GWSQ36ME.js").then((c) => c.HomeComponent)
      },
      {
        path: "lien-he",
        loadComponent: () => import("./chunk-FISR5IG5.js").then((c) => c.LienheComponent)
      },
      {
        path: ":slug",
        ...
        loadComponent: () => __async(void 0, null, function* () {
          ...
          if (componentType) {
            switch (componentType) {
              case "danhmucbaiviet":
                const c = yield import("./chunk-YXYEGW4X.js");
                return c.DanhmucbaivietComponent;
              case "baiviet":
                const c_1 = yield import("./chunk-YFPN3IJY.js");
                return c_1.BaivietComponent;
              case "danhmuc":
                const c_2 = yield import("./chunk-R7DTGYSP.js");
                return c_2.DanhmucComponent;
              case "sanpham":
                const c_3 = yield import("./chunk-HAVVVNFD.js");
                return c_3.SanphamComponent;
              case "danhmucgioithieu":
                const c_5 = yield import("./chunk-WOWNIIYP.js");
                return c_5.DanhmucgioithieuComponent;
              case "gioithieu":
                const c_6 = yield import("./chunk-HULOPUZH.js");
                return c_6.GioithieuComponent;
              default:
                const c_4 = yield import("./chunk-UEDVNAXX.js");
                return c_4.NotfoundComponent;
            }
          } else {
            return import("./chunk-GWSQ36ME.js").then((c) => c.HomeComponent);
          }
        })
      }
    ]
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-6S6K6IKK.js").then((m) => m);
