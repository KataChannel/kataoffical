import {
  FIREBASE_OPTIONS
} from "./chunk-JNW6WKUV.js";
import "./chunk-7VZTPIES.js";
import "./chunk-VAYYIO2B.js";
...
var routes = [
  ...
  __spreadValues({
    path: "404",
    loadComponent: () => import("./chunk-GP3XAQGP.js").then((c) => c.NotfoundComponent)
  }, false ? { \u0275entryName: "src/app/site/notfound/notfound.component.ts" } : {}),
  __spreadValues({
    path: "admin",
    canActivate: [AuthGuard],
    loadComponent: () => import("./chunk-TS4HQFSJ.js").then((c) => c.AdminmainComponent),
    children: [
      {
        path: "bulk-price-update",
        loadComponent: () => import("./chunk-WXKZ3HLV.js").then((m) => m.BulkPriceUpdateComponent)
      },
      {
        path: "price-alerts",
        loadComponent: () => import("./chunk-2SNG7AIT.js").then((m) => m.PriceAlertsComponent)
      },
      {
        path: "price-analytics",
        loadComponent: () => import("./chunk-4MEFVVR3.js").then((m) => m.PriceAnalyticsComponent)
      },
      {
        path: "price-comparison",
        loadComponent: () => import("./chunk-TLTNZZHD.js").then((m) => m.PriceComparisonComponent)
      },
      {
        path: "auditlog",
        canActivate: [PermissionGuard],
        data: { permission: "auditlog.view" },
        loadChildren: () => import("./chunk-AN3IUOBS.js").then((m) => m.AuditlogRoutingModule)
      },
      {
        path: "performance",
        loadComponent: () => import("./chunk-MSWLOI32.js").then((c) => c.PerformanceComponent)
      },
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-DQNIJO5M.js").then((c) => c.DashboardComponent)
      },
      {
        path: "dashboard/baocaodoanhthu",
        loadComponent: () => import("./chunk-YXUTOCQZ.js").then((c) => c.BaocaodoanhtuComponent)
      },
      {
        path: "thongke",
        loadChildren: () => import("./chunk-MXKKUYX6.js").then((m) => m.THONGKE_ROUTES)
      },
      {
        path: "testing",
        loadComponent: () => import("./chunk-V7U3FBE6.js").then((c) => c.TestingComponent)
      },
      {
        path: "performance",
        canActivate: [PermissionGuard],
      ...
      {
        path: "lienheadmin",
        loadComponent: () => import("./chunk-EQQ3UAWV.js").then((c) => c.LienheadminComponent)
      },
      {
        path: "menu",
        canActivate: [PermissionGuard],
        data: { permission: "menu.view" },
        loadComponent: () => import("./chunk-COXO4BLS.js").then((c) => c.ListMenuComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-COXO4BLS.js").then((c) => c.ListMenuComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-VQSHAERJ.js").then((c) => c.DetailMenuComponent)
          }
        ]
      },
      {
        path: "hotro",
        loadComponent: () => import("./chunk-3GNJVWWI.js").then((c) => c.ListHotroComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-SSC3RP47.js").then((c) => c.DetailHotroComponent)
          }
        ]
      },
      {
        path: "support",
        loadComponent: () => import("./chunk-RZG26RDI.js").then((c) => c.SupportListComponent)
      },
      {
        path: "support/new",
        loadComponent: () => import("./chunk-TO7XMR2L.js").then((c) => c.SupportCreateComponent)
      },
      {
        path: "support/:id",
        loadComponent: () => import("./chunk-DYT7AMYF.js").then((c) => c.SupportDetailComponent)
      },
      {
        path: "nhomuser",
        canActivate: [PermissionGuard],
        data: { permission: "nhomuser.view" },
        loadComponent: () => import("./chunk-GY7WLCBS.js").then((c) => c.ListRoleComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-GY7WLCBS.js").then((c) => c.ListRoleComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-6UBM77CG.js").then((c) => c.DetailRoleComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-EMO4I62I.js").then((c) => c.ListPermissionComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-EMO4I62I.js").then((c) => c.ListPermissionComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-V6GOXPLD.js").then((c) => c.DetailPermissionComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-GJUGZST7.js").then((c) => c.UserPermissionManagementComponent)
      },
      // {
      ...
      // },
      {
        ...
        loadChildren: () => import("./chunk-3WS7XAMX.js").then((m) => m.phongbanRoutes)
      },
      {
        path: "nhanvien",
        canActivate: [PermissionGuard],
        data: { permission: "nhanvien.view" },
        loadChildren: () => import("./chunk-QOPAHKTY.js").then((m) => m.nhanvienRoutes)
      },
      {
        path: "importdata",
        canActivate: [PermissionGuard],
        data: { permission: "importdata.view" },
        loadChildren: () => import("./chunk-U6UPQHL4.js").then((m) => m.ImportdataRoutingModule)
      },
      {
        path: "danhmuc",
        loadComponent: () => import("./chunk-6UI5HCDZ.js").then((c) => c.ListdanhmucComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-XOIKENPZ.js").then((c) => c.DetailDanhmucComponent)
          }
        ]
      },
      {
        path: "baiviet",
        loadComponent: () => import("./chunk-G2E6ZQKT.js").then((c) => c.ListbaivietComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-VW3HXNIG.js").then((c) => c.DetailBaivietComponent)
          }
        ]
      },
      {
        path: "goooglesheets",
        loadComponent: () => import("./chunk-YDLYSBJH.js").then((c) => c.GooglesheetsComponent)
      },
      {
        path: "sanpham",
        canActivate: [PermissionGuard],
        data: { permission: "sanpham.view" },
        loadComponent: () => import("./chunk-PIR75DU7.js").then((c) => c.ListSanphamComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-PIR75DU7.js").then((c) => c.ListSanphamComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-5HCSKNLI.js").then((c) => c.DetailSanphamComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-CSTSAKSF.js").then((c) => c.ListBanggiaComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-CSTSAKSF.js").then((c) => c.ListBanggiaComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-QFC35DTK.js").then((c) => c.DetailBanggiaComponent)
          }
        ]
      },
      {
        ...
        loadChildren: () => import("./chunk-SUSPBP5S.js").then((m) => m.KhachhangRoutingModule)
      },
      // {
      //   path: 'khachhang',
      //   canActivate: [PermissionGuard],
      ...
      // },
      {
        ...
        loadComponent: () => import("./chunk-WREGDXJM.js").then((c) => c.ListNhomkhachhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-WREGDXJM.js").then((c) => c.ListNhomkhachhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-4I6HCHDU.js").then((c) => c.DetailNhomkhachhangComponent)
          }
        ]
      },
      {
        ...
        loadChildren: () => import("./chunk-AYYQJS2W.js").then((m) => m.NhacungcapRoutingModule)
      },
      {
        path: "nhomncc",
        canActivate: [PermissionGuard],
        data: { permission: "nhomncc.view" },
        loadChildren: () => import("./chunk-NWCZPYUM.js").then((m) => m.NhomnccRoutingModule)
      },
      {
        path: "dathang",
        canActivate: [PermissionGuard],
        data: { permission: "dathang.view" },
        loadComponent: () => import("./chunk-R5AEG3PV.js").then((c) => c.ListDathangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-R5AEG3PV.js").then((c) => c.ListDathangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-OBU26J33.js").then((c) => c.DetailDathangComponent)
          }
        ]
      },
      {
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-GMGXD72U.js").then((c) => c.ListDonhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-GMGXD72U.js").then((c) => c.ListDonhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-6PRQUTBS.js").then((c) => c.DetailDonhangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-HPVYGTC5.js").then((c) => c.VandonComponent)
      },
      {
        path: "phieuchuyen",
        canActivate: [PermissionGuard],
        data: { permission: "phieuchuyen.view" },
        loadComponent: () => import("./chunk-ROIUKHWR.js").then((c) => c.ListPhieuchuyenComponent)
      },
      {
        path: "kho",
        loadComponent: () => import("./chunk-7DRRVJN6.js").then((c) => c.ListKhoComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-7DRRVJN6.js").then((c) => c.ListKhoComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-6SWARHY6.js").then((c) => c.DetailKhoComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-XOVH243D.js").then((c) => c.ListPhieugiaohangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-XOVH243D.js").then((c) => c.ListPhieugiaohangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-FCRGZMYJ.js").then((c) => c.DetailPhieugiaohangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-PVAPOZ2H.js").then((c) => c.ListPhieuchiahangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-PVAPOZ2H.js").then((c) => c.ListPhieuchiahangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-IIGT2RV5.js").then((c) => c.DetailPhieuchiahangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-6PMTEWAO.js").then((c) => c.ListPhieukhoComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-6PMTEWAO.js").then((c) => c.ListPhieukhoComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-KFFZOWEB.js").then((c) => c.DetailPhieukhoComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-4FUANCSP.js").then((c) => c.XuatnhaptonComponent)
        // children: [
        //   {
        //     path: ':id',
        //     loadComponent: () =>
      ...
      },
      {
        ...
        loadChildren: () => import("./chunk-LXO7FHAC.js").then((m) => m.ChotkhoRoutingModule)
      },
      {
        path: "congnokhachhang",
        canActivate: [PermissionGuard],
        data: { permission: "congnokhachhang.view" },
        loadComponent: () => import("./chunk-FPZKVJ2I.js").then((c) => c.ListcongnokhachhangComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-FPZKVJ2I.js").then((c) => c.ListcongnokhachhangComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-OHTMJEY4.js").then((c) => c.DetailCongnokhachhangComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-NXBT4FDH.js").then((c) => c.ListUserguideComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-NXBT4FDH.js").then((c) => c.ListUserguideComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-JIHZCWJE.js").then((c) => c.DetailUserguideComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-COBAMLTW.js").then((c) => c.ListcongnonccComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-COBAMLTW.js").then((c) => c.ListcongnonccComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-7PUJXU3Q.js").then((c) => c.DetailCongnonccComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-YSHIT4IA.js").then((c) => c.ListUserComponent),
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-YSHIT4IA.js").then((c) => c.ListUserComponent)
          ...
          {
            path: ":id",
            loadComponent: () => import("./chunk-7XIUMZCY.js").then((c) => c.DetailUserComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-QA7FHPFE.js").then((c) => c.ListquanlyfileComponent),
        children: [
          {
            path: ":id",
            loadComponent: () => import("./chunk-5A46J7PX.js").then((c) => c.DetailQuanlyfileComponent)
          }
        ]
      },
      {
        ...
        loadComponent: () => import("./chunk-5GR5TTBF.js").then((c) => c.ProfileComponent),
        children: [
          {
            path: "socialpage",
            loadComponent: () => import("./chunk-E3Q4PDNE.js").then((c) => c.SocialComponent)
          }
        ]
      },
      {
      ...
      {
        path: "account",
        loadComponent: () => import("./chunk-XRX64QHA.js").then((c) => c.AccountComponent),
        children: [
          {
            path: "password",
            loadComponent: () => import("./chunk-CJP7WRZO.js").then((c) => c.PasswordComponent)
          },
          {
            path: "general",
            loadComponent: () => import("./chunk-GQZCRLFH.js").then((c) => c.GeneralComponent)
          }
        ]
      }
    ]
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-G76KTGTO.js").then((c) => c.LoginComponent)
  }, false ? { \u0275entryName: "src/app/shared/common/users/login/login.component.ts" } : {}),
  __spreadValues({
    path: "register",
    canActivate: [GuestGuard],
    canActivateChild: [GuestGuard],
    loadComponent: () => import("./chunk-EZ4Y6LUQ.js").then((c) => c.RegisterComponent)
  }, false ? { \u0275entryName: "src/app/shared/common/users/register/register.component.ts" } : {}),
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-UYOCDXQJ.js").then((c) => c.SitemainComponent),
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-4QRXW63K.js").then((c) => c.HomeComponent)
      },
      {
        path: "lien-he",
        loadComponent: () => import("./chunk-MUDFCCTB.js").then((c) => c.LienheComponent)
      },
      {
        path: ":slug",
        ...
        loadComponent: () => __async(void 0, null, function* () {
          ...
          if (componentType) {
            switch (componentType) {
              case "danhmucbaiviet":
                const c = yield import("./chunk-TLFZNH6D.js");
                return c.DanhmucbaivietComponent;
              case "baiviet":
                const c_1 = yield import("./chunk-7KAKI5KI.js");
                return c_1.BaivietComponent;
              case "danhmuc":
                const c_2 = yield import("./chunk-XGMRS4SI.js");
                return c_2.DanhmucComponent;
              case "sanpham":
                const c_3 = yield import("./chunk-KP3ARJVR.js");
                return c_3.SanphamComponent;
              case "danhmucgioithieu":
                const c_5 = yield import("./chunk-V2NEPUNG.js");
                return c_5.DanhmucgioithieuComponent;
              case "gioithieu":
                const c_6 = yield import("./chunk-LZJ7LJ2X.js");
                return c_6.GioithieuComponent;
              default:
                const c_4 = yield import("./chunk-GP3XAQGP.js");
                return c_4.NotfoundComponent;
            }
          } else {
            return import("./chunk-4QRXW63K.js").then((c) => c.HomeComponent);
          }
        })
      }
    ]
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-GO7IQHVU.js").then((m) => m);
