...
var ImportDataValidationService = class _ImportDataValidationService {
  ...
  static transformSanphamData(data) {
    return data.map((item) => __spreadProps(__spreadValues({}, item), {
      ...
      loadpoint: Number(item.loadpoint) || 0,
...
var ListImportdataComponent = class _ListImportdataComponent {
  ...
  constructor() {
    ...
    effect(() => __async(this, null, function* () {
      ...
      try {
        yield this._ImportdataService.getAllImportdata(1e3, true);
  ...
  convertBGSPToExport(listbanggia, listsp) {
    const validBanggia = listbanggia.filter((item) => item.mabanggia && item.mabanggia.trim() !== "");
    const pricingTables = new Set(validBanggia.map((item) => item.mabanggia.trim()));
    console.log("Valid pricing tables for export:", Array.from(pricingTables));
    console.log("listsp", listsp);
    return listsp.map((product) => {
      const result = {
        masp: product.masp || "",
        title: product.title || "",
        giaban: product.giaban?.toString() || "0"
      };
      Array.from(pricingTables).forEach((mabanggia) => {
        const banggia = validBanggia.find((bg) => bg.mabanggia === mabanggia);
        const sanphamInBG = banggia?.sanpham?.find((sp) => sp.masp === product.masp);
  ...
  convertBGSPToImport(data) {
    ...
    const boardKeys = allKeys.filter((key) => {
      ...
      const hasValidPrice = data.some((sp) => {
        const value = sp[key];
        return value !== void 0 && value !== null && value !== "" && value !== 0 && value !== "0";
      });
    ...
    const data1 = boardKeys.map((boardKey) => __spreadProps(__spreadValues(__spreadValues({
      mabanggia: boardKey,
      title: `B\u1EA3ng gi\xE1 ${boardKey.replace("BG", "")}`
    }, batdau && { batdau }), ketthuc && { ketthuc }), {
      // Only include if ketthuc exists
      sanpham: data.filter((sp) => sp.masp && sp.masp.trim() !== "").map((sp) => ({
  ...
  DoImportData(data) {
    return __async(this, null, function* () {
      ...
      if (data.banggiasanpham && data.banggiasanpham.length > 0 && this.ListEdit().some((item) => item.value === "banggiasanpham")) {
        ...
        const cleanedData = data.banggiasanpham.filter((item) => {
          return item.masp && item.masp.trim() !== "";
        });
        if (cleanedData.length === 0) {
          this._snackBar.open("Kh\xF4ng c\xF3 d\u1EEF li\u1EC7u b\u1EA3ng gi\xE1 s\u1EA3n ph\u1EA9m h\u1EE3p l\u1EC7", "", {
            duration: 3e3,
            horizontalPosition: "end",
            verticalPosition: "top",
            panelClass: ["snackbar-warning"]
        ...
        if (listBGSP.length === 0) {
          this._snackBar.open("Kh\xF4ng t\xECm th\u1EA5y b\u1EA3ng gi\xE1 h\u1EE3p l\u1EC7 trong d\u1EEF li\u1EC7u import", "", {
            duration: 3e3,
            horizontalPosition: "end",
            verticalPosition: "top",
            panelClass: ["snackbar-warning"]
        ...
        const importSnackbar = this._snackBar.open(`\u0110ang import ${fixedListBGSP.length} b\u1EA3ng gi\xE1 s\u1EA3n ph\u1EA9m...`, "", {
          horizontalPosition: "end",
          verticalPosition: "top",
          panelClass: ["snackbar-warning"]
        });
        try {
          ...
          importSnackbar.dismiss();
          this._snackBar.open(`Import th\xE0nh c\xF4ng ${fixedListBGSP.length} b\u1EA3ng gi\xE1 s\u1EA3n ph\u1EA9m!`, "", {
            duration: 2e3,
            horizontalPosition: "end",
            verticalPosition: "top",
            panelClass: ["snackbar-success"]
          ...
          importSnackbar.dismiss();
          this._snackBar.open("C\xF3 l\u1ED7i x\u1EA3y ra khi import b\u1EA3ng gi\xE1 s\u1EA3n ph\u1EA9m", "", {
            duration: 3e3,
            horizontalPosition: "end",
            verticalPosition: "top",
            panelClass: ["snackbar-error"]
      ...
      if (data.xuatnhapton && data.xuatnhapton.length > 0 && this.ListEdit().some((item) => item.value === "xuatnhapton")) {
        ...
        data.xuatnhapton.forEach((v) => {
          if (!v.masp || v.slton === void 0 || v.slton === null) {
          ...
          if (exitItem) {
            ...
            if (difference > 0) {
              ...
              if (sanpham && sanpham.id) {
                phieuNhapDetails.push({
                  ...
                  soluong: difference,
                  ghichu: `\u0110i\u1EC1u ch\u1EC9nh t\u0103ng t\u1EEB ${currentQuantity} l\xEAn ${newQuantity}`
                });
              } else {
                console.warn(`S\u1EA3n ph\u1EA9m kh\xF4ng t\xECm th\u1EA5y cho m\xE3: ${v.masp}`);
              }
            ...
            console.warn(`T\u1ED3n kho kh\xF4ng t\xECm th\u1EA5y cho m\xE3 s\u1EA3n ph\u1EA9m: ${v.masp}`);
          }
        });
        ...
        try {
          if (phieuNhapDetails.length > 0) {
            ...
            if (invalidNhapItems.length > 0) {
              ...
              throw new Error(`${invalidNhapItems.length} s\u1EA3n ph\u1EA9m nh\u1EADp kh\xF4ng h\u1EE3p l\u1EC7`);
            }
          }
          if (phieuXuatDetails.length > 0) {
            ...
            if (invalidXuatItems.length > 0) {
              ...
              throw new Error(`${invalidXuatItems.length} s\u1EA3n ph\u1EA9m xu\u1EA5t kh\xF4ng h\u1EE3p l\u1EC7`);
            }
          }
          if (phieuNhapDetails.length > 0) {
            console.log("Creating phieu nhap with details:", phieuNhapDetails);
            const phieuNhapData = {
              title: `\u0110i\u1EC1u Ch\u1EC9nh Nh\u1EADp Kho ${(0, import_moment.default)().format("DD/MM/YYYY")}`,
              type: "nhap",
              sanpham: phieuNhapDetails,
              ghichu: `C\u1EADp nh\u1EADt t\u1ED3n kho t\u0103ng l\xFAc ${(0, import_moment.default)().format("HH:mm:ss DD/MM/YYYY")}`,
              ngay: (0, import_moment.default)().toDate(),
              khoId: "4cc01811-61f5-4bdc-83de-a493764e9258",
              isActive: true
            };
            yield this._PhieukhoService.CreatePhieukho(phieuNhapData);
            this._snackBar.open(`T\u1EA1o phi\u1EBFu nh\u1EADp th\xE0nh c\xF4ng v\u1EDBi ${phieuNhapDetails.length} s\u1EA3n ph\u1EA9m`, "", {
              duration: 3e3,
              horizontalPosition: "end",
              verticalPosition: "top",
              panelClass: ["snackbar-success"]
          ...
          if (phieuXuatDetails.length > 0) {
            ...
            const phieuXuatData = {
              title: `\u0110i\u1EC1u Ch\u1EC9nh Xu\u1EA5t Kho ${(0, import_moment.default)().format("DD/MM/YYYY")}`,
              type: "xuat",
              sanpham: phieuXuatDetails,
              ghichu: `C\u1EADp nh\u1EADt t\u1ED3n kho gi\u1EA3m l\xFAc ${(0, import_moment.default)().format("HH:mm:ss DD/MM/YYYY")}`,
              ngay: (0, import_moment.default)().toDate(),
              khoId: "4cc01811-61f5-4bdc-83de-a493764e9258",
              isActive: true
            };
            yield this._PhieukhoService.CreatePhieukho(phieuXuatData);
            this._snackBar.open(`T\u1EA1o phi\u1EBFu xu\u1EA5t th\xE0nh c\xF4ng v\u1EDBi ${phieuXuatDetails.length} s\u1EA3n ph\u1EA9m`, "", {
              duration: 3e3,
              horizontalPosition: "end",
              verticalPosition: "top",
              panelClass: ["snackbar-success"]
          ...
          if (phieuNhapDetails.length === 0 && phieuXuatDetails.length === 0) {
            this._snackBar.open("Kh\xF4ng c\xF3 thay \u0111\u1ED5i t\u1ED3n kho n\xE0o c\u1EA7n x\u1EED l\xFD", "", {
              duration: 2e3,
              horizontalPosition: "end",
              verticalPosition: "top",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListImportdataComponent, { className: "ListImportdataComponent", filePath: "src/app/admin/importdata/listimportdata/listimportdata.component.ts", lineNumber: 103 });
})();
...
//# sourceMappingURL=chunk-BZYY4D5N.mjs.map
