...
function DetailSanphamComponent_ng_container_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(77, "\xC1p D\u1EE5ng");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(78, DetailSanphamComponent_ng_container_16_button_78_Template, 2, 2, "button", 42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var DetailSanphamComponent = class _DetailSanphamComponent {
  ...
  InitListNhacungcap() {
    return __async(this, null, function* () {
      const ListNhacungcap = yield this._GraphqlService.findAll("nhacungcap", {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DetailSanphamComponent, { className: "DetailSanphamComponent", filePath: "src/app/admin/sanpham/detailsanpham/detailsanpham.component.ts", lineNumber: 37 });
})();
export {
  DetailSanphamComponent
};
//# sourceMappingURL=chunk-BKDU7HKQ.mjs.map
