...
export default {
  ...
  assets: {
    'index.csr.html': {size: 72880, hash: '89a954d6de388d05fe3b281163010e42635258a58b9eb6ee2d9549bd5631d9fd', text: () => import('./assets-chunks/index_csr_html.mjs').then(m => m.default)},
    'index.server.html': {size: 24171, hash: 'c3d406350562af3e6640601c11bc6cd9a0da2d89dc3f4b5ab4edf1193759b808', text: () => import('./assets-chunks/index_server_html.mjs').then(m => m.default)},
    'styles-MV7GXKZD.css': {size: 155486, hash: 'UWHdyIgeBdE', text: () => import('./assets-chunks/styles-MV7GXKZD_css.mjs').then(m => m.default)}
  },
};
