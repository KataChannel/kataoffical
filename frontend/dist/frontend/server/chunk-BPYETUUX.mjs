...
var phongbanRoutes = [
  ...
  __spreadValues({
    path: "list",
    loadComponent: () => import("./chunk-O2FCIGE3.mjs").then((m) => m.ListPhongbanComponent),
    data: {
  ...
  __spreadValues({
    path: "create",
    loadComponent: () => import("./chunk-IORD5CUR.mjs").then((m) => m.FormPhongbanComponent),
    data: {
  ...
  __spreadValues({
    path: "detail/:id",
    loadComponent: () => import("./chunk-DRPYZUPL.mjs").then((m) => m.DetailPhongbanComponent),
    data: {
...
//# sourceMappingURL=chunk-BPYETUUX.mjs.map
