...
function ListChotkhoComponent_button_13_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_button_13_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_button_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function ListChotkhoComponent_button_13_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext();
      const DeleteDialog_r4 = \u0275\u0275reference(56);
      return \u0275\u0275resetView(ctx_r2.openDeleteDialog(DeleteDialog_r4));
    });
    \u0275\u0275template(1, ListChotkhoComponent_button_13_Conditional_1_Template, 2, 0, "mat-icon", 38)(2, ListChotkhoComponent_button_13_Conditional_2_Template, 2, 0, "mat-icon");
...
function ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 52);
    \u0275\u0275listener("click", function ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_0_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r7);
...
function ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 53);
    \u0275\u0275listener("click", function ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_1_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const item_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(4);
      ctx_r2.toggleColumn(item_r8);
...
function ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_0_Template, 5, 3, "button", 50)(1, ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Conditional_1_Template, 5, 2, "button", 51);
  }
  if (rf & 2) {
...
function ListChotkhoComponent_For_51_Conditional_1_th_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th", 40)(1, "button", 44)(2, "mat-icon");
    \u0275\u0275text(3, "tune");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "mat-menu", null, 8)(6, "div", 45)(7, "mat-form-field", 46)(8, "input", 47);
    \u0275\u0275listener("input", function ListChotkhoComponent_For_51_Conditional_1_th_0_Template_input_input_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.doFilterColumns($event));
    })("click", function ListChotkhoComponent_For_51_Conditional_1_th_0_Template_input_click_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ListChotkhoComponent_For_51_Conditional_1_th_0_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275repeaterCreate(15, ListChotkhoComponent_For_51_Conditional_1_th_0_For_16_Template, 2, 1, null, null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function ListChotkhoComponent_For_51_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListChotkhoComponent_For_51_Conditional_1_th_0_Template, 17, 1, "th", 43);
  }
}
function ListChotkhoComponent_For_51_Conditional_2_th_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "th", 41)(1, "span", 55);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "app-searchfilter", 56);
    \u0275\u0275listener("OutFilter", function ListChotkhoComponent_For_51_Conditional_2_th_0_Template_app_searchfilter_OutFilter_3_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function ListChotkhoComponent_For_51_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListChotkhoComponent_For_51_Conditional_2_th_0_Template, 4, 6, "th", 54);
  }
}
function ListChotkhoComponent_For_51_td_3_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 62);
    \u0275\u0275listener("click", function ListChotkhoComponent_For_51_td_3_Case_1_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
function ListChotkhoComponent_For_51_td_3_Case_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "check");
    \u0275\u0275elementEnd();
...
function ListChotkhoComponent_For_51_td_3_Case_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_For_51_td_3_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 63);
    \u0275\u0275listener("click", function ListChotkhoComponent_For_51_td_3_Case_2_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r15);
      const row_r14 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.AddToEdit(row_r14));
    });
    \u0275\u0275template(1, ListChotkhoComponent_For_51_td_3_Case_2_Conditional_1_Template, 2, 0, "mat-icon")(2, ListChotkhoComponent_For_51_td_3_Case_2_Conditional_2_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r14 = \u0275\u0275nextContext().$implicit;
...
function ListChotkhoComponent_For_51_td_3_Case_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_For_51_td_3_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 60);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function ListChotkhoComponent_For_51_td_3_Case_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 60);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListChotkhoComponent_For_51_td_3_Case_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 61)(1, "mat-chip", 64);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ListChotkhoComponent_For_51_td_3_Case_7_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_For_51_td_3_Case_7_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_For_51_td_3_Case_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 60);
    \u0275\u0275template(1, ListChotkhoComponent_For_51_td_3_Case_7_Conditional_1_Template, 2, 0, "mat-icon", 65)(2, ListChotkhoComponent_For_51_td_3_Case_7_Conditional_2_Template, 2, 0, "mat-icon", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r14 = \u0275\u0275nextContext().$implicit;
...
function ListChotkhoComponent_For_51_td_3_Case_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 60);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListChotkhoComponent_For_51_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 57);
    \u0275\u0275template(1, ListChotkhoComponent_For_51_td_3_Case_1_Template, 2, 1, "span", 58)(2, ListChotkhoComponent_For_51_td_3_Case_2_Template, 3, 1, "span", 59)(3, ListChotkhoComponent_For_51_td_3_Case_3_Template, 3, 4, "span", 60)(4, ListChotkhoComponent_For_51_td_3_Case_4_Template, 3, 4, "span", 60)(5, ListChotkhoComponent_For_51_td_3_Case_5_Template, 2, 1, "span", 60)(6, ListChotkhoComponent_For_51_td_3_Case_6_Template, 3, 1, "span", 61)(7, ListChotkhoComponent_For_51_td_3_Case_7_Template, 3, 1, "span", 60)(8, ListChotkhoComponent_For_51_td_3_Case_8_Template, 2, 1, "span", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_22_0;
...
function ListChotkhoComponent_For_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 33);
    \u0275\u0275template(1, ListChotkhoComponent_For_51_Conditional_1_Template, 1, 0, "th", 40)(2, ListChotkhoComponent_For_51_Conditional_2_Template, 1, 0, "th", 41)(3, ListChotkhoComponent_For_51_td_3_Template, 9, 1, "td", 42);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ListChotkhoComponent_tr_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 67);
  }
}
function ListChotkhoComponent_tr_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r17 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 68);
    \u0275\u0275listener("click", function ListChotkhoComponent_tr_53_Template_tr_click_0_listener() {
...
function ListChotkhoComponent_tr_54_Template(rf, ctx) {
  if (rf & 1) {
...
function ListChotkhoComponent_ng_template_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 71)(2, "div", 72);
...
function ListChotkhoComponent_ng_template_57_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275element(1, "mat-progress-bar", 84);
...
function ListChotkhoComponent_ng_template_57_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 76)(2, "div", 77);
    \u0275\u0275text(3, "Import Excel File");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 78)(5, "input", 79);
    \u0275\u0275listener("change", function ListChotkhoComponent_ng_template_57_Template_input_change_5_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onFileSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, ListChotkhoComponent_ng_template_57_div_6_Template, 4, 2, "div", 80);
    \u0275\u0275elementStart(7, "div", 81)(8, "button", 82);
    \u0275\u0275listener("click", function ListChotkhoComponent_ng_template_57_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r19);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ListChotkhoComponent_ng_template_59_div_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275element(1, "mat-progress-bar", 84);
    \u0275\u0275elementStart(2, "div", 85);
...
function ListChotkhoComponent_ng_template_59_Template(rf, ctx) {
  if (rf & 1) {
    const _r20 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 76)(2, "div", 77);
    \u0275\u0275text(3, "Export to Excel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 78)(5, "mat-form-field", 86)(6, "mat-label");
    \u0275\u0275text(7, "Export Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "mat-select", 87);
    \u0275\u0275twoWayListener("valueChange", function ListChotkhoComponent_ng_template_59_Template_mat_select_valueChange_8_listener($event) {
      \u0275\u0275restoreView(_r20);
      const ctx_r2 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r2.exportType, $event) || (ctx_r2.exportType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(9, "mat-option", 88);
    \u0275\u0275text(10, "All Data");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "mat-option", 89);
    \u0275\u0275text(12, "Filtered Data");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "mat-option", 90);
    \u0275\u0275text(14, "Selected Items");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(15, ListChotkhoComponent_ng_template_59_div_15_Template, 4, 2, "div", 80);
    \u0275\u0275elementStart(16, "div", 81)(17, "button", 82);
    \u0275\u0275listener("click", function ListChotkhoComponent_ng_template_59_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r20);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ListChotkhoComponent_ng_template_61_div_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r22 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78)(1, "mat-form-field", 86)(2, "mat-label");
    \u0275\u0275text(3, "Backup Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-select", 87);
    \u0275\u0275twoWayListener("valueChange", function ListChotkhoComponent_ng_template_61_div_4_Template_mat_select_valueChange_4_listener($event) {
      \u0275\u0275restoreView(_r22);
      const ctx_r2 = \u0275\u0275nextContext(2);
      \u0275\u0275twoWayBindingSet(ctx_r2.backupType, $event) || (ctx_r2.backupType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(5, "mat-option", 91);
    \u0275\u0275text(6, "Full Backup");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "mat-option", 92);
    \u0275\u0275text(8, "Incremental Backup");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(9, "mat-form-field", 86)(10, "mat-label");
    \u0275\u0275text(11, "Backup Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "input", 93);
    \u0275\u0275twoWayListener("ngModelChange", function ListChotkhoComponent_ng_template_61_div_4_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r22);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function ListChotkhoComponent_ng_template_61_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r23 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 78)(1, "input", 94);
    \u0275\u0275listener("change", function ListChotkhoComponent_ng_template_61_div_5_Template_input_change_1_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function ListChotkhoComponent_ng_template_61_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 78);
    \u0275\u0275element(1, "mat-progress-bar", 84);
    \u0275\u0275elementStart(2, "div", 85);
...
function ListChotkhoComponent_ng_template_61_Template(rf, ctx) {
  if (rf & 1) {
    const _r21 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 76)(2, "div", 77);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ListChotkhoComponent_ng_template_61_div_4_Template, 13, 2, "div", 80)(5, ListChotkhoComponent_ng_template_61_div_5_Template, 2, 0, "div", 80)(6, ListChotkhoComponent_ng_template_61_div_6_Template, 4, 2, "div", 80);
    \u0275\u0275elementStart(7, "div", 81)(8, "button", 82);
    \u0275\u0275listener("click", function ListChotkhoComponent_ng_template_61_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r21);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ListChotkhoComponent_ng_template_63_div_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 98)(1, "div", 99)(2, "span", 100);
    \u0275\u0275text(3, "Database");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 101)(5, "mat-icon", 102);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 101)(13, "mat-icon", 102);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span", 103);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "div", 99)(18, "span", 100);
    \u0275\u0275text(19, "Memory Usage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 101)(21, "mat-icon", 102);
    \u0275\u0275text(22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "span", 103);
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 104)(26, "span", 100);
    \u0275\u0275text(27, "Last Check");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(28, "span", 103);
    \u0275\u0275text(29);
    \u0275\u0275pipe(30, "date");
    \u0275\u0275elementEnd()()();
  }
...
function ListChotkhoComponent_ng_template_63_Template(rf, ctx) {
  if (rf & 1) {
    const _r24 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-dialog-content")(1, "div", 95)(2, "div", 77);
    \u0275\u0275text(3, "System Health Status");
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, ListChotkhoComponent_ng_template_63_div_4_Template, 31, 16, "div", 96);
    \u0275\u0275elementStart(5, "div", 81)(6, "button", 97);
    \u0275\u0275listener("click", function ListChotkhoComponent_ng_template_63_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r24);
      const ctx_r2 = \u0275\u0275nextContext();
...
function ListChotkhoComponent_ng_template_65_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 108)(6, "button", 74);
...
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListChotkhoComponent, selectors: [["app-listchotkho"]], viewQuery: function ListChotkhoComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(12, "search");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(13, ListChotkhoComponent_button_13_Template, 5, 3, "button", 19);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "div", 20)(15, "div", 21)(16, "strong");
      \u0275\u0275text(17);
      \u0275\u0275elementEnd();
      \u0275\u0275text(18, " - ");
      ...
      \u0275\u0275text(26, "Trang");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(27, "div", 23)(28, "span", 24, 1);
      \u0275\u0275text(30);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "mat-menu", null, 2)(33, "div", 25);
      \u0275\u0275listener("click", function ListChotkhoComponent_Template_div_click_33_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView($event.stopPropagation());
      });
      \u0275\u0275elementStart(34, "mat-form-field", 26)(35, "mat-label");
      \u0275\u0275text(36, "S\u1ED1 l\u01B0\u1EE3ng");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "input", 27);
      \u0275\u0275twoWayListener("ngModelChange", function ListChotkhoComponent_Template_input_ngModelChange_37_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ListChotkhoComponent_Template_button_click_38_listener() {
        \u0275\u0275restoreView(_r1);
        const menuHienthi_r5 = \u0275\u0275reference(29);
        return \u0275\u0275resetView(ctx.onPageSizeChange(ctx.pageSize(), menuHienthi_r5));
      });
      \u0275\u0275elementStart(39, "mat-icon");
      \u0275\u0275text(40, "published_with_changes");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(41, "div", 29)(42, "button", 30);
      \u0275\u0275listener("click", function ListChotkhoComponent_Template_button_click_42_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onPreviousPage());
      });
      \u0275\u0275elementStart(43, "mat-icon");
      \u0275\u0275text(44, "keyboard_arrow_left");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "button", 30);
      \u0275\u0275listener("click", function ListChotkhoComponent_Template_button_click_45_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onNextPage());
      });
      \u0275\u0275elementStart(46, "mat-icon");
      \u0275\u0275text(47, "keyboard_arrow_right");
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(48, "div", 31)(49, "table", 32);
      \u0275\u0275repeaterCreate(50, ListChotkhoComponent_For_51_Template, 4, 2, "ng-container", 33, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275template(52, ListChotkhoComponent_tr_52_Template, 1, 0, "tr", 34)(53, ListChotkhoComponent_tr_53_Template, 1, 3, "tr", 35)(54, ListChotkhoComponent_tr_54_Template, 3, 0, "tr", 36);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(55, ListChotkhoComponent_ng_template_55_Template, 11, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(57, ListChotkhoComponent_ng_template_57_Template, 12, 2, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(59, ListChotkhoComponent_ng_template_59_Template, 21, 3, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(61, ListChotkhoComponent_ng_template_61_Template, 12, 6, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(63, ListChotkhoComponent_ng_template_63_Template, 10, 1, "ng-template", null, 7, \u0275\u0275templateRefExtractor)(65, ListChotkhoComponent_ng_template_65_Template, 10, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
      const menu1_r25 = \u0275\u0275reference(32);
      \u0275\u0275advance();
...
//# sourceMappingURL=chunk-ZPRA5HWX.mjs.map
