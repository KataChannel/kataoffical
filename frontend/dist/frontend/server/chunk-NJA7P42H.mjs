...
var ChotkhoService = class _ChotkhoService {
  ...
  getTraceLog(chotkhoId, sanphamId) {
    return __async(this, null, function* () {
      try {
        this.isLoading.set(true);
        const response = yield firstValueFrom(this.http.get(`${environment.APIURL}/chotkho/${chotkhoId}/trace-log/${sanphamId}`, {
          headers: {
        ...
        this.showErrorMessage("L\u1ED7i khi l\u1EA5y d\u1EEF li\u1EC7u \u0111\u1ED1i so\xE1t");
        return null;
      } finally {
  ...
  getProductTimeline(sanphamId, khoId, fromDate, toDate) {
    return __async(this, null, function* () {
      try {
        this.isLoading.set(true);
        const response = yield firstValueFrom(this.http.get(`${environment.APIURL}/chotkho/products/${sanphamId}/timeline`, {
          params: {
            khoId,
            fromDate,
            toDate
  ...
  getNegativeStockReport() {
    return __async(this, null, function* () {
      try {
        this.isLoading.set(true);
        const response = yield firstValueFrom(this.http.get(`${environment.APIURL}/chotkho/negative-stock-report`, {
          headers: {
            Authorization: `Bearer ${this.storageService.getItem("token")}`
          }
        }));
        ...
        console.error("Error getting negative stock report:", error);
        return null;
      } finally {
        this.isLoading.set(false);
      }
   ...
   */
  getPendingOrders(khoId) {
    return __async(this, null, function* () {
      try {
        this.isLoading.set(true);
        const response = yield firstValueFrom(this.http.get(`${environment.APIURL}/chotkho/pending-orders/${khoId}`, {
          headers: {
            Authorization: `Bearer ${this.storageService.getItem("token")}`
          }
        }));
  ...
  createChotkhoWithDetails(data) {
    return __async(this, null, function* () {
      try {
        ...
        const detailsData = data.details && data.details.length > 0 ? data.details.map((detail) => ({
      ...
      `;
        const variables = {
          data: {
            ...
            details: detailsData,
            confirmOrderIds: data.confirmOrderIds || []
          }
        };
        ...
        this.showSuccessMessage(masterResult.message || `T\u1EA1o ch\u1ED1t kho th\xE0nh c\xF4ng`);
...
//# sourceMappingURL=chunk-NJA7P42H.mjs.map
