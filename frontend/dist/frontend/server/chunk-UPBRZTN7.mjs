...
function ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 48);
    \u0275\u0275listener("click", function ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_0_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r7);
...
function ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 49);
    \u0275\u0275listener("click", function ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_1_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r9);
      const item_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(4);
      ctx_r2.toggleColumn(item_r8);
...
function ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_0_Template, 5, 3, "button", 46)(1, ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Conditional_1_Template, 5, 2, "button", 47);
  }
  if (rf & 2) {
...
function ListPermissionComponent_For_56_Conditional_1_th_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("input", function ListPermissionComponent_For_56_Conditional_1_th_0_Template_input_input_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.doFilterColumns($event));
    })("click", function ListPermissionComponent_For_56_Conditional_1_th_0_Template_input_click_8_listener($event) {
      \u0275\u0275restoreView(_r6);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ListPermissionComponent_For_56_Conditional_1_th_0_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(3);
    ...
    \u0275\u0275repeaterCreate(15, ListPermissionComponent_For_56_Conditional_1_th_0_For_16_Template, 2, 1, null, null, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function ListPermissionComponent_For_56_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListPermissionComponent_For_56_Conditional_1_th_0_Template, 17, 1, "th", 39);
  }
}
function ListPermissionComponent_For_56_Conditional_2_th_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("OutFilter", function ListPermissionComponent_For_56_Conditional_2_th_0_Template_app_searchfilter_OutFilter_3_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext(3);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("icon", "filter_alt")("ListItem", ctx_r2.Listpermission())("fieldsearch", column_r12)("ListFilter", ctx_r2.ListFilter)("filterItem", ctx_r2.FilterHederColumn(ctx_r2.Listpermission(), column_r12));
  }
}
function ListPermissionComponent_For_56_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ListPermissionComponent_For_56_Conditional_2_th_0_Template, 4, 6, "th", 50);
  }
}
function ListPermissionComponent_For_56_td_3_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 57);
    \u0275\u0275listener("click", function ListPermissionComponent_For_56_td_3_Case_1_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r13);
...
function ListPermissionComponent_For_56_td_3_Case_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListPermissionComponent_For_56_td_3_Case_2_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListPermissionComponent_For_56_td_3_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r15 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 58);
    \u0275\u0275listener("click", function ListPermissionComponent_For_56_td_3_Case_2_Template_span_click_0_listener() {
      \u0275\u0275restoreView(_r15);
      const row_r14 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.AddToEdit(row_r14));
    });
    \u0275\u0275template(1, ListPermissionComponent_For_56_td_3_Case_2_Conditional_1_Template, 2, 0, "mat-icon")(2, ListPermissionComponent_For_56_td_3_Case_2_Conditional_2_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r14 = \u0275\u0275nextContext().$implicit;
...
function ListPermissionComponent_For_56_td_3_Case_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ListPermissionComponent_For_56_td_3_Case_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 56);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ListPermissionComponent_For_56_td_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 53);
    \u0275\u0275template(1, ListPermissionComponent_For_56_td_3_Case_1_Template, 2, 1, "span", 54)(2, ListPermissionComponent_For_56_td_3_Case_2_Template, 3, 1, "span", 55)(3, ListPermissionComponent_For_56_td_3_Case_3_Template, 3, 4, "span", 56)(4, ListPermissionComponent_For_56_td_3_Case_4_Template, 2, 1, "span", 56);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_17_0;
    const column_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_17_0 = column_r12) === "codeId" ? 1 : tmp_17_0 === "stt" ? 2 : tmp_17_0 === "createdAt" ? 3 : 4);
  }
}
function ListPermissionComponent_For_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 31);
    \u0275\u0275template(1, ListPermissionComponent_For_56_Conditional_1_Template, 1, 0, "th", 36)(2, ListPermissionComponent_For_56_Conditional_2_Template, 1, 0, "th", 37)(3, ListPermissionComponent_For_56_td_3_Template, 5, 1, "td", 38);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ListPermissionComponent_tr_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 59);
  }
}
function ListPermissionComponent_tr_58_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 60);
  }
  if (rf & 2) {
...
function ListPermissionComponent_tr_59_Template(rf, ctx) {
  if (rf & 1) {
...
function ListPermissionComponent_ng_template_60_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("B\u1EA1n ch\u1EAFc ch\u1EAFn mu\u1ED1n xo\xE1 ", ctx_r2.EditList.length, " permission kh\xF4ng?");
  }
}
var ListPermissionComponent = class _ListPermissionComponent {
  ...
  router;
  snackBar;
  displayedColumns = ["stt", "codeId", "name", "group", "description", "status", "createdAt"];
  AllColumn = ["stt", "codeId", "name", "group", "description", "status", "order", "createdAt", "updatedAt"];
  ColumnName = {
    stt: "#",
    codeId: "Code",
    name: "Ti\xEAu \u0110\u1EC1",
  ...
  drawer;
  // Services
  constructor(permissionService, dialog, router, snackBar) {
  ...
  loadPermissions() {
    return __async(this, null, function* () {
      try {
        yield this.permissionService.getAllPermission(this.pageSize(), true);
    ...
    return __async(this, null, function* () {
      try {
        for (const permission of this.EditList) {
          yield this.permissionService.DeletePermission(permission.id);
        }
        this.snackBar.open(`\u0110\xE3 x\xF3a ${this.EditList.length} permission th\xE0nh c\xF4ng`, "\u0110\xF3ng", { duration: 3e3 });
        this.EditList = [];
        yield this.loadPermissions();
      } catch (error) {
        this.snackBar.open("L\u1ED7i khi x\xF3a permission: " + error.message, "\u0110\xF3ng", { duration: 3e3 });
      }
    });
  }
  static \u0275fac = function ListPermissionComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ListPermissionComponent)(\u0275\u0275directiveInject(PermissionService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MatSnackBar));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListPermissionComponent, selectors: [["app-listpermission"]], viewQuery: function ListPermissionComponent_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275text(17, "T\u1EA1o M\u1EDBi");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(18, ListPermissionComponent_button_18_Template, 5, 0, "button", 17);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275listener("click", function ListPermissionComponent_Template_div_click_38_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView($event.stopPropagation());
      });
      ...
      \u0275\u0275twoWayListener("ngModelChange", function ListPermissionComponent_Template_input_ngModelChange_42_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ListPermissionComponent_Template_button_click_43_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ListPermissionComponent_Template_button_click_47_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275listener("click", function ListPermissionComponent_Template_button_click_50_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275repeaterCreate(55, ListPermissionComponent_For_56_Template, 4, 2, "ng-container", 31, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275template(57, ListPermissionComponent_tr_57_Template, 1, 0, "tr", 32)(58, ListPermissionComponent_tr_58_Template, 1, 3, "tr", 33)(59, ListPermissionComponent_tr_59_Template, 3, 0, "tr", 34);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(60, ListPermissionComponent_ng_template_60_Template, 11, 1, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListPermissionComponent, { className: "ListPermissionComponent", filePath: "src/app/admin/permission/listpermission/listpermission.component.ts", lineNumber: 45 });
})();

export {
  ListPermissionComponent
};
//# sourceMappingURL=chunk-UPBRZTN7.mjs.map
