...
var DonhangService = class _DonhangService {
  ...
  PreviewDongboGia(list) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const response = yield fetch(`${environment.APIURL}/donhang/dongbogia-preview`, options);
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        return yield response.json();
      } catch (error) {
        console.error("L\u1ED7i khi preview \u0111\u1ED3ng b\u1ED9 gi\xE1:", error);
        return { previews: [] };
      }
    });
  }
  ...
  UpdateBulkDonhang(ids, status = "danhan") {
    return __async(this, null, function* () {
      try {
        const options = {
          method: "PATCH",
...
//# sourceMappingURL=chunk-KJDLSRZI.mjs.map
