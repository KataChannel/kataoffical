  ...
  getPhieukhoByRange(start, end) {
    return __async(this, null, function* () {
      try {
        ...
        const response = yield fetch(`${environment.APIURL}/phieukho/range?start=${start}&end=${end}`, options);
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = yield response.json();
  ...
  getNextCode(type) {
    return __async(this, null, function* () {
      try {
        ...
        const response = yield fetch(`${environment.APIURL}/phieukho/next-code/${type}`, options);
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
...
//# sourceMappingURL=chunk-YBTIEM5M.mjs.map
