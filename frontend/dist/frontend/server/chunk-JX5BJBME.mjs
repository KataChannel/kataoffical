...
function ListBanggiaComponent_div_5_button_33_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function ListBanggiaComponent_div_5_button_33_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function ListBanggiaComponent_div_5_button_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 34);
    \u0275\u0275listener("click", function ListBanggiaComponent_div_5_button_33_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      const DeleteDialog_r7 = \u0275\u0275reference(15);
      return \u0275\u0275resetView(ctx_r1.openDeleteDialog(DeleteDialog_r7));
    });
    \u0275\u0275template(1, ListBanggiaComponent_div_5_button_33_Conditional_1_Template, 2, 0, "mat-icon", 35)(2, ListBanggiaComponent_div_5_button_33_Conditional_2_Template, 2, 0, "mat-icon");
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isLoading() ? 1 : 2);
  }
}
function ListBanggiaComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9, "tune");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "mat-menu", null, 2)(12, "div", 21)(13, "mat-form-field", 22)(14, "input", 23);
    ...
    \u0275\u0275listener("click", function ListBanggiaComponent_div_5_Template_button_click_23_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.ExportExcel(ctx_r1.dataSource.data, "Banggia"));
    });
    ...
    \u0275\u0275listener("click", function ListBanggiaComponent_div_5_Template_span_click_31_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(32);
    \u0275\u0275elementEnd();
    \u0275\u0275template(33, ListBanggiaComponent_div_5_button_33_Template, 5, 2, "button", 32);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.EditList.length > 0);
  }
}
function ListBanggiaComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 36)(1, "mat-form-field", 22)(2, "mat-label");
...
function ListBanggiaComponent_For_10_th_1_div_23_Case_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const column_r11 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", item_r13[column_r11], "%");
  }
}
...
function ListBanggiaComponent_For_10_th_1_div_23_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_18_0 = column_r11) === "createdAt" ? 2 : tmp_18_0 === "updatedAt" ? 3 : tmp_18_0 === "haohut" ? 4 : 5);
  }
}
function ListBanggiaComponent_For_10_th_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 43, 4);
    \u0275\u0275text(5, " filter_alt ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-menu", null, 2)(8, "div", 44);
    \u0275\u0275listener("click", function ListBanggiaComponent_For_10_th_1_Template_div_click_8_listener($event) {
      \u0275\u0275restoreView(_r10);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275elementStart(9, "div", 45)(10, "input", 46);
    ...
    \u0275\u0275text(13, "search");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 49)(15, "div", 17)(16, "span", 50);
    ...
    \u0275\u0275template(23, ListBanggiaComponent_For_10_th_1_div_23_Template, 6, 2, "div", 52);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 53)(25, "button", 54);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(14);
    \u0275\u0275textInterpolate1("Ch\u1ECDn T\u1EA5t C\u1EA3 ", ctx_r1.FilterHederColumn(ctx_r1.dataSource.filteredData, column_r11).length || 0, "");
    \u0275\u0275advance(6);
...
function ListBanggiaComponent_For_10_td_2_Case_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "span", 61)(1, "mat-icon", 64);
    \u0275\u0275listener("click", function ListBanggiaComponent_For_10_td_2_Case_2_Template_mat_icon_click_1_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.Banggiamacdinh(row_r18));
    });
    \u0275\u0275text(2, "bookmark");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span");
  ...
  if (rf & 2) {
    ...
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275classMapInterpolate1("!z-10 ", row_r18.isDefault ? "!text-blue-600" : "text-gray-600", "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(row_r18[column_r11]);
  }
}
function ListBanggiaComponent_For_10_td_2_Case_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r19 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "span", 62)(1, "span", 64);
    \u0275\u0275listener("click", function ListBanggiaComponent_For_10_td_2_Case_3_Template_span_click_1_listener() {
      \u0275\u0275restoreView(_r19);
      const row_r18 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.goToDetail(row_r18));
    });
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
...
function ListBanggiaComponent_For_10_td_2_Case_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", row_r18[column_r11], " ");
  }
}
function ListBanggiaComponent_For_10_td_2_Case_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (tmp_16_0 = ctx_r1.getName(ctx_r1.ListStatus, "value", row_r18[column_r11])) == null ? null : tmp_16_0.title, " ");
  }
}
function ListBanggiaComponent_For_10_td_2_Case_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, row_r18[column_r11], "dd/MM/yyyy"), " ");
  }
}
...
function ListBanggiaComponent_For_10_td_2_Case_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(2, 1, row_r18[column_r11], "HH:mm:ss dd/MM/yyyy"), " ");
  }
}
...
function ListBanggiaComponent_For_10_td_2_Case_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 60);
    \u0275\u0275template(1, ListBanggiaComponent_For_10_td_2_Case_9_Conditional_1_Template, 2, 0, "mat-icon", 65)(2, ListBanggiaComponent_For_10_td_2_Case_9_Conditional_2_Template, 2, 0, "mat-icon", 66);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const row_r18 = \u0275\u0275nextContext().$implicit;
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(row_r18[column_r11] ? 1 : 2);
  }
}
...
function ListBanggiaComponent_For_10_td_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, ListBanggiaComponent_For_10_td_2_Case_1_Template, 2, 1, "span", 60)(2, ListBanggiaComponent_For_10_td_2_Case_2_Template, 5, 4, "span", 61)(3, ListBanggiaComponent_For_10_td_2_Case_3_Template, 3, 1, "span", 62)(4, ListBanggiaComponent_For_10_td_2_Case_4_Template, 2, 1, "span", 60)(5, ListBanggiaComponent_For_10_td_2_Case_5_Template, 2, 1, "span", 60)(6, ListBanggiaComponent_For_10_td_2_Case_6_Template, 3, 4, "span", 60)(7, ListBanggiaComponent_For_10_td_2_Case_7_Template, 3, 4, "span", 60)(8, ListBanggiaComponent_For_10_td_2_Case_8_Template, 3, 4, "span", 63)(9, ListBanggiaComponent_For_10_td_2_Case_9_Template, 3, 1, "span", 60)(10, ListBanggiaComponent_For_10_td_2_Case_10_Template, 3, 4, "span", 63)(11, ListBanggiaComponent_For_10_td_2_Case_11_Template, 2, 1, "span", 60);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_15_0;
    const column_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_15_0 = column_r11) === "STT" ? 1 : tmp_15_0 === "mabanggia" ? 2 : tmp_15_0 === "title" ? 3 : tmp_15_0 === "sanpham" ? 4 : tmp_15_0 === "status" ? 5 : tmp_15_0 === "batdau" ? 6 : tmp_15_0 === "ketthuc" ? 7 : tmp_15_0 === "createdAt" ? 8 : tmp_15_0 === "isActive" ? 9 : tmp_15_0 === "updatedAt" ? 10 : 11);
  }
}
function ListBanggiaComponent_For_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0, 12);
    \u0275\u0275template(1, ListBanggiaComponent_For_10_th_1_Template, 29, 5, "th", 39)(2, ListBanggiaComponent_For_10_td_2_Template, 12, 1, "td", 40);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
function ListBanggiaComponent_tr_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ListBanggiaComponent_tr_12_Template_tr_click_0_listener() {
      const row_r21 = \u0275\u0275restoreView(_r20).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.AddToEdit(row_r21));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMapInterpolate1("hover:bg-slate-100 ", ctx_r1.CheckItemInEdit(row_r21) ? "!bg-slate-200" : "", "");
  }
}
...
function ListBanggiaComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
...
var ListBanggiaComponent = class _ListBanggiaComponent {
  ...
  _BanggiaGraphqlService = inject(BanggiaService);
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      try {
        const banggiaData = yield this._GraphqlService.findMany("banggia", {
          include: {
        ...
        console.error("L\u1ED7i kh\u1EDFi t\u1EA1o danh s\xE1ch b\u1EA3ng gi\xE1:", error);
      }
    });
  }
  refresh() {
    return __async(this, null, function* () {
      try {
        ...
        console.error("L\u1ED7i l\xE0m m\u1EDBi danh s\xE1ch b\u1EA3ng gi\xE1:", error);
        this._snackBar.open("C\xF3 l\u1ED7i x\u1EA3y ra khi l\xE0m m\u1EDBi danh s\xE1ch", "\u0110\xF3ng", {
  ...
  Banggiamacdinh(item) {
    return __async(this, null, function* () {
      try {
        const banggiaSanpham = yield this._GraphqlService.findMany("banggiasanpham", {
        ...
        const updatePromises = banggiaSanpham.map((bgsp) => this._GraphqlService.updateOne("sanpham", { id: bgsp.sanphamId }, { giaban: bgsp.giaban }));
        yield Promise.all(updatePromises);
        this._snackBar.open(`\u0110\xE3 c\u1EADp nh\u1EADt gi\xE1 b\xE1n m\u1EB7c \u0111\u1ECBnh cho ${banggiaSanpham.length} s\u1EA3n ph\u1EA9m t\u1EEB b\u1EA3ng gi\xE1 ${item.title}`, "\u0110\xF3ng", {
          horizontalPosition: "end",
          verticalPosition: "top",
        ...
        console.error("L\u1ED7i c\u1EADp nh\u1EADt gi\xE1 b\xE1n m\u1EB7c \u0111\u1ECBnh:", error);
  ...
  doFilterHederColumn(event, column) {
    this.dataSource.filteredData = this.dataSource.data.filter((v) => removeVietnameseAccents(v[column]).includes(event.target.value.toLowerCase()) || v[column].toLowerCase().includes(event.target.value.toLowerCase()));
  ...
  ApplyFilterColum(menu) {
    this.dataSource.data = this.dataSource.data.filter((v) => this.ListFilter.some((v1) => v1.id === v.id));
    this.dataSource.paginator = this.paginator;
    this.dataSource.sort = this.sort;
    menu.closeMenu();
  }
    ...
    return __async(this, null, function* () {
      try {
        ...
        for (const bg of ListBG) {
          yield this._GraphqlService.createOne("banggia", {
        ...
        for (const item of ListData) {
          yield this._GraphqlService.createOne("banggiasanpham", item);
        }
        ...
        for (const kh of BGKH) {
          yield this._GraphqlService.createOne("banggiaKhachhang", kh);
        }
        ...
        this._snackBar.open("C\xF3 l\u1ED7i x\u1EA3y ra khi import d\u1EEF li\u1EC7u", "\u0110\xF3ng", {
          horizontalPosition: "end",
          verticalPosition: "top",
          panelClass: ["snackbar-error"],
          duration: 3e3
  ...
  ExportExcel(data, title) {
    return __async(this, null, function* () {
      try {
        const ListSP = yield this._GraphqlService.findMany("sanpham", {
          select: { id: true, masp: true, title: true, giaban: true }
        });
        const result = this.convertToData3(data, ListSP);
        const Banggia = yield this._GraphqlService.findMany("banggia", {
          include: {
            banggiaKhachhang: {
              include: {
                khachhang: {
        ...
        const ListKH = Banggia.reduce((acc, v) => {
          if (Array.isArray(v.banggiaKhachhang)) {
            v.banggiaKhachhang.forEach((bgkh) => {
              acc.push({
                mabanggia: v.mabanggia,
        ...
        const BanggiaExport = Banggia.map((v) => {
          return {
            mabanggia: v.mabanggia,
            type: v.type,
        ...
        this._snackBar.open("C\xF3 l\u1ED7i x\u1EA3y ra khi export d\u1EEF li\u1EC7u", "\u0110\xF3ng", {
          horizontalPosition: "end",
          verticalPosition: "top",
          panelClass: ["snackbar-error"],
          duration: 3e3
  ...
  DeleteListItem() {
    return __async(this, null, function* () {
      ...
      try {
        const result = yield this._BanggiaGraphqlService.DeleteBulkBanggia(this.EditList);
        this._snackBar.open(result.message || `X\xF3a th\xE0nh c\xF4ng ${result.success} b\u1EA3ng gi\xE1${result.fail > 0 ? `, ${result.fail} l\u1ED7i` : ""}`, "", {
          duration: 3e3,
          horizontalPosition: "end",
          verticalPosition: "top",
  ...
  }, decls: 16, vars: 7, consts: [["drawer", ""], ["DeleteDialog", ""], ["menu", "matMenu"], ["uploadfile", ""], ["menuTrigger", "matMenuTrigger"], ["autosize", "", 1, "w-full", "h-full"], ["mode", "over", 1, "flex", "flex-col", "!w-full", "h-full", 3, "position"], [1, "flex", "flex-col", "space-y-2", "h-screen-12", "w-full", "p-2"], ["class", "cursor-pointer w-full relative flex lg:flex-row lg:space-y-2 space-y-0 flex-col space-x-2 justify-between items-center p-2 bg-white rounded-lg", 4, "ngIf"], ["class", "py-2 w-full flex flex-row space-x-2 items-center", 4, "ngIf"], [1, "w-full", "overflow-auto"], ["mat-table", "", "matSort", "", 1, "!border", "w-full", "h-full", "cursor-pointer", 3, "dataSource"], [3, "matColumnDef"], ["mat-header-row", "", 4, "matHeaderRowDef", "matHeaderRowDefSticky"], ["mat-row", "", 3, "class", "click", 4, "matRowDef", "matRowDefColumns"], ["class", "mat-row", 4, "matNoDataRow"], [1, "cursor-pointer", "w-full", "relative", "flex", "lg:flex-row", "lg:space-y-2", "space-y-0", "flex-col", "space-x-2", "justify-between", "items-center", "p-2", "bg-white", "rounded-lg"], [1, "flex", "flex-row", "space-x-2", "items-center"], ["matTooltip", "Th\xEAm m\u1EDBi", "mat-flat-button", "", 1, "flex", "flex-row", "items-center", "btn-primary", 3, "click"], [1, "whitespace-nowrap"], ["matTooltip", "\u1EA8n hi\u1EC7n c\u1ED9t", "mat-icon-button", "", "color", "primary", "aria-label", "Example icon-button with a menu", 3, "matMenuTriggerFor"], [1, "p-4"], ["appearance", "outline", "subscriptSizing", "dynamic", 1, "w-full"], ["matInput", "", "placeholder", "T\xECm Ki\u1EBFm", 3, "input", "click"], ["matPrefix", ""], [1, "flex", "flex-col", "max-h-80", "overflow-auto"], ["mat-menu-item", ""], ["matTooltip", "T\xECm Ki\u1EBFm", "color", "primary", "mat-icon-button", "", 3, "click"], ["matTooltip", "T\u1EA3i file excel M\u1EABu", "color", "primary", "mat-icon-button", "", 3, "click"], ["matTooltip", "T\u1EA3i l\xEAn file excel", "color", "primary", "mat-icon-button", "", 3, "click"], ["type", "file", 1, "hidden", 3, "change"], [1, "lg:flex", "hidden", "whitespace-nowrap", "p-2", "rounded-lg", "bg-slate-200", 3, "click"], ["class", "flex flex-row items-center", "color", "warn", "matTooltip", "Xo\xE1", "mat-flat-button", "", 3, "disabled", "click", 4, "ngIf"], ["mat-menu-item", "", 3, "click"], ["color", "warn", "matTooltip", "Xo\xE1", "mat-flat-button", "", 1, "flex", "flex-row", "items-center", 3, "click", "disabled"], [1, "animate-spin"], [1, "py-2", "w-full", "flex", "flex-row", "space-x-2", "items-center"], ["matInput", "", "placeholder", "Vui l\xF2ng T\xECm Ki\u1EBFm", 3, "keyup"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["class", "whitespace-nowrap", "mat-header-cell", "", "mat-sort-header", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-cell", "", "mat-sort-header", "", 1, "whitespace-nowrap"], [1, "max-w-40", "line-clamp-4", "me-4"], [1, "z-10", "material-symbols-outlined", "text-gray-500", 3, "matMenuTriggerFor"], [1, "cursor-pointer", "flex", "flex-col", "space-y-4", "p-3", 3, "click"], [1, "relative", "w-full"], ["type", "text", "placeholder", "T\xECm Ki\u1EBFm...", 1, "block", "w-full", "pl-10", "pr-4", "py-2", "text-gray-700", "bg-white", "border", "border-gray-300", "rounded-lg", "focus:border-blue-400", "focus:ring-blue-400", "focus:outline-none", "focus:ring", "focus:ring-opacity-40", 3, "keyup"], [1, "absolute", "inset-y-0", "left-0", "flex", "items-center", "pl-3", "pointer-events-none"], [1, "material-symbols-outlined", "text-gray-500"], [1, "flex", "flex-row", "space-x-2", "items-center", "justify-between"], [1, "text-xs", "text-blue-600", "underline", 3, "click"], [1, "w-full", "flex", "flex-col", "space-y-2", "max-h-44", "overflow-auto"], ["class", "flex flex-row space-x-2 items-center p-2 rounded-lg hover:bg-slate-100", 3, "click", 4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "flex", "flex-row", "space-x-2", "items-end", "justify-end"], ["mat-flat-button", "", "color", "warn", 3, "click"], ["mat-flat-button", "", "color", "primary", 3, "click"], [1, "flex", "flex-row", "space-x-2", "items-center", "p-2", "rounded-lg", "hover:bg-slate-100", 3, "click"], ["class", "material-symbols-outlined text-blue-600", 4, "ngIf"], [1, "material-symbols-outlined", "text-blue-600"], ["mat-cell", ""], [1, "max-w-40", "line-clamp-4"], [1, "flex", "gap-2", "max-w-40", "line-clamp-4", "items-center"], [1, "flex", "max-w-40", "line-clamp-4", "font-bold", "text-blue-700"], [1, "max-w-40", "line-clamp-4", "text-xs"], [3, "click"], [1, "text-green-500"], [1, "text-red-500"], ["mat-header-row", ""], ["mat-row", "", 3, "click"], [1, "mat-row"], ["colspan", "4", 1, "mat-cell", "p-4"], [1, "flex", "flex-col", "space-y-8", "items-center", "justify-center"], [1, "font-bold"], [1, "flex", "flex-row", "space-x-2", "items-center", "justify-center"], ["mat-flat-button", "", "color", "primary", "mat-dialog-close", "true"], ["mat-flat-button", "", "color", "warn", "mat-dialog-close", "false"]], template: function ListBanggiaComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "mat-drawer-container", 5)(1, "mat-drawer", 6, 0);
      \u0275\u0275element(3, "router-outlet");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "div", 7);
      \u0275\u0275template(5, ListBanggiaComponent_div_5_Template, 34, 3, "div", 8)(6, ListBanggiaComponent_div_6_Template, 8, 0, "div", 9);
      \u0275\u0275elementStart(7, "div", 10)(8, "table", 11);
      \u0275\u0275repeaterCreate(9, ListBanggiaComponent_For_10_Template, 3, 1, "ng-container", 12, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275template(11, ListBanggiaComponent_tr_11_Template, 1, 0, "tr", 13)(12, ListBanggiaComponent_tr_12_Template, 1, 3, "tr", 14)(13, ListBanggiaComponent_tr_13_Template, 3, 0, "tr", 15);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(14, ListBanggiaComponent_ng_template_14_Template, 11, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListBanggiaComponent, { className: "ListBanggiaComponent", filePath: "src/app/admin/banggia/listbanggia/listbanggia.component.ts", lineNumber: 56 });
})();
function memoize() {
...
//# sourceMappingURL=chunk-JX5BJBME.mjs.map
