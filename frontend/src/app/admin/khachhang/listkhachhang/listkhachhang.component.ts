...
import { CHINHANH_VTTECH } from '../../../shared/utils/chinhanh.utils';
...
export class ListKhachhangComponent implements OnInit {
  ...
  Columns: any[] = [];
  ListChinhanh:any = CHINHANH_VTTECH
  ...
  async ngOnInit(): Promise<void> {
    ...
    await this._KhachhangService.getKhachhangBy({branchId:[14,15,16,17,18,21]});
