...
//       // If madonhang already exists, increment maxOrder until we find an unused one
...
//       console.log('Max Order:', maxOrder, 'Final Order:', newOrder, 'Final Madonhang:', madonhang);
