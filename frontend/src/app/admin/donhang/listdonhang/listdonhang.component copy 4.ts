...
//     // const result = await this._DonhangService.ImportDonhangCu(confirmedImportData);
//     this.DoImportKhachhangCu(confirmedImportData);
...
//   /**
//    * Toggle order expansion to show/hide product details
//    */
...
//   /**
//    * Get products for an order from ListImportData
//    */
...
//       return total + (product.slgiao || product.soluong || 0);
//     }, 0);
//   }
...
//    */
//   getOrderTotal(detail: any): number {
//     const products = this.getOrderProducts(detail);
//     return products.reduce((total, product) => {
//       return total + this.getProductTotal(product);
//     }, 0);
//   }
...
//     const quantity = product.slgiao || product.soluong || 0;
...
//   /**
//    * Get total products count across all confirmed orders
//    */
//   getTotalProducts(): number {
//     const confirmedDetails = this.statusDetails.filter(detail => 
//       detail.status === 'Processed' && detail.configOptions?.confirmed
//     );
//     return confirmedDetails.reduce((total, detail) => {
//       return total + this.getOrderProducts(detail).length;
//     }, 0);
//   }

//   /**
//    * Get total amount across all confirmed orders
//    */
...
//     );
//     return confirmedDetails.reduce((total, detail) => {
//       return total + this.getOrderTotal(detail);
//     }, 0);
//   }
...
//     const processedDetails = this.statusDetails.filter(d => d.status === 'Processed');
//     const allExpanded = processedDetails.every(detail => detail.expanded);
...
//     const processedDetails = this.statusDetails.filter(d => d.status === 'Processed');
//     return processedDetails.length > 0 && processedDetails.every(detail => detail.expanded);
//   }
// }
// function memoize() {
//   return function (
