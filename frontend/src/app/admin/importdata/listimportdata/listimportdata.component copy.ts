...
//     const ListBGKH:any[] =rawListKH.map((v: any) => {
//             const result: any = {
//             makh: v.makh || '',
//             name: v.name || '',
//            };
//        for (const banggia of rawListBG) {
...
//     const dynamicKeys = rawListSP.reduce((acc: Record<string, string>, v: any) => {
//       if (v && v.masp) {
//       acc[v.masp] = '';
//       }
//       return acc;
...
//     const ListNCCSP: any[] = rawListNCC.map((supplier: any) => {
//       const result: any = {
...
//     {
//         const ListBGKH = this.convertBHKHToImport(data.banggiakhachhang);
...
//     {
//      console.log(data.nhacungcapsanpham);
//     }
//     // if(data.nhacungcapsanpham && data.nhacungcapsanpham.length > 0 && this.ListEdit().some((item: any) => item.value === 'nhacungcapsanpham'))
//     // {
//     //    const ListNCCSP = this.convertNCCSPToImport(data.nhacungcapsanpham);
//     //    await this._NhacungcapService.importSPNCC(ListNCCSP);
//     // }
