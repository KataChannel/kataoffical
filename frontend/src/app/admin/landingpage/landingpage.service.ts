...
export class LandingpageService {
  ...
  async CreateLandingpage(dulieu: any) {
    try {
      const options = {
        ...
        const response = await fetch(`${environment.APIURL}/landingpage`, options);
        if (!response.ok) {
  ...
  async getAllLandingpage() {
    ...
    try {
      ...
      const lastUpdatedResponse = await fetch(`${environment.APIURL}/last-updated?table=landingPage`, options);
  ...
  async getLandingpageBy(param: any) {
    try {
      ...
      const response = await fetch(`${environment.APIURL}/landingpage/findby`, options);      
      if (!response.ok) {
        this.handleError(response.status);
      }
      const data = await response.json();      
  ...
  async updateLandingpage(dulieu: any) {
    try {
      const options = {
        ...
        const response = await fetch(`${environment.APIURL}/landingpage/${dulieu.id}`, options);
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  async DeleteLandingpage(item:any) {    
    try {
        const options = {
          ...
          const response = await fetch(`${environment.APIURL}/landingpage/${item.id}`, options);
          if (!response.ok) {
            this.handleError(response.status);
          }
          this.getAllLandingpage()
