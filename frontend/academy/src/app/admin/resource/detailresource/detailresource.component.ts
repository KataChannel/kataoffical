import { ChangeDetectionStrategy, Component, effect, inject, signal, TemplateRef } from '@angular/core';
...
export class DetailResourceComponent {
  ...
  async handleChooseFile(file: any) {
    await this.DetailResource.update((v: any) => {
      v.url = file.url;
      return v;
    });
    if (file) {
