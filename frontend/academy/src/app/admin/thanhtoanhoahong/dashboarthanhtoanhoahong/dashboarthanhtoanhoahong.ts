...
@Component({
  selector: 'app-dashboarthanhtoanhoahong',
  imports: [
    DashboardblockComponent,
    RevenuechartComponent
  ],
  templateUrl: './dashboarthanhtoanhoahong.html',
  styleUrl: './dashboarthanhtoanhoahong.scss'
})
export class DashboarthanhtoanhoahongComponent {
