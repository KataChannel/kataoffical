...
@Component({
  selector: 'app-dashboaraffiliatelink',
  imports: [
    DashboardblockComponent,
    RevenuechartComponent
  ],
  templateUrl: './dashboaraffiliatelink.component.html',
  styleUrl: './dashboaraffiliatelink.component.scss'
})
export class DashboaraffiliatelinkComponent {
