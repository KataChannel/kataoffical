...
@Component({
  selector: 'app-dashboarfilemanager',
  imports: [
    DashboardblockComponent,
    RevenuechartComponent
  ],
  templateUrl: './dashboarfilemanager.component.html',
  styleUrl: './dashboarfilemanager.component.scss'
})
export class DashboarfilemanagerComponent {
