...
,
  ...
  <button *ngIf="EditList.length > 0" (click)="openDeleteDialog(DeleteDialog)" class="flex flex-row items-center" color="warn" matTooltip="Xoá" mat-flat-button>
    <mat-icon>delete</mat-icon>
      ...
      <table class="!border w-full cursor-pointer" mat-table [dataSource]="dataSource" matSort>
        ...
        <ng-container [matColumnDef]="column">
          <th class="whitespace-nowrap" mat-header-cell *matHeaderCellDef mat-sort-header>
            ...
            <app-searchfilter [icon]="'filter_alt'" [ListItem]="this.List${entityNameLower}()" [fieldsearch]="column"
