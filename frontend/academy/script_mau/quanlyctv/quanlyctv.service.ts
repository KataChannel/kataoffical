  ...
  export class QuanlyctvService {
    ...
    async CreateQuanlyctv(dulieu: any) {
      try {
        const options = {
          ...
          const response = await fetch(`${environment.APIURL}/quanlyctv`, options);
          if (!response.ok) {
    ...
    async getAllQuanlyctv() {
      ...
      try {
        ...
        const lastUpdatedResponse = await fetch(`${environment.APIURL}/last-updated?table=quanlyctv`, options);
    ...
    async getQuanlyctvBy(param: any) {
      try {
        ...
        const response = await fetch(`${environment.APIURL}/quanlyctv/findby`, options);      
        if (!response.ok) {
          this.handleError(response.status);
        }
        const data = await response.json();      
    ...
    async updateQuanlyctv(dulieu: any) {
      try {
        const options = {
          ...
          const response = await fetch(`${environment.APIURL}/quanlyctv/${dulieu.id}`, options);
          if (!response.ok) {
            throw new Error(`HTTP error! status: ${response.status}`);
          }
          const data = await response.json();
    ...
    async DeleteQuanlyctv(item:any) {    
      try {
          const options = {
            ...
            const response = await fetch(`${environment.APIURL}/quanlyctv/${item.id}`, options);
            if (!response.ok) {
              this.handleError(response.status);
            }
            this.getAllQuanlyctv()
