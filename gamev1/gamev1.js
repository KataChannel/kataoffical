...
// Helper to normalize file keys for consistent lookup
...
const projectStructure = {
  ...
  'src/app': ['app.component.ts', 'app.component.html', 'app.component.css', 'app.module.ts'],
  'src/assets/sprites': [], // Placeholders
  'src/environments': ['environment.ts'],
  'src': ['main.ts', 'styles.css', 'tsconfig.json']
};

// File contents (same as your provided data)
const filesContent = {
...
function createStructure() {
  ...
  Object.keys(projectStructure).forEach(folder => {
    ...
    projectStructure[folder].forEach(file => {
      ...
      const fileKey = normalizePath(path.join(folder, file));
      const content = filesContent[fileKey] || '';
