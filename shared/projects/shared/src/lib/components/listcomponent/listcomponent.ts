...
export class ListComponentComponent {
  ...
  Columns: any[] = [];
  ListFilter: any[] = [];
  page:any = this.componentService.page||  signal(1);
  totalPages:any = this.componentService.totalPages|| signal(1);
  total:any = this.componentService.total|| signal(0);
  pageSize:any = this.componentService.pageSize|| signal(50);
