...
//         const [authData, cookies] = await getToken();    
...
//             console.log(`Fetching data from ${currentStart.format('YYYY-MM-DD')} to ${endDate.format('YYYY-MM-DD')}`);
...
//             const [newAuthData, newCookies] = await getToken();
