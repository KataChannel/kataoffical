...
async function makeApiRequest(token, cookies, params) {
    try {
        const response = await axios({
            method: 'post',
            url: apiConfig.apiTreatmentListUrl, // Use treatment list URL from config
            headers: {
 ...
 */
async function getAllDieutri(startDate = '2025-01-01', endDate = '2025-12-31', batchSize = 100, delayBetweenRequests = 1000) {
