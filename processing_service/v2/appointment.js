...
async function makeApiRequest(token, cookies, params) {
    try {
        const response = await axios({
            method: 'post',
            url: apiConfig.apiAppointmentListUrl, // Use revenue list URL from config
            headers: {
 ...
 */
async function getAllLichhen(startDate = '2019-01-01', batchSize = 100, delayBetweenRequests = 1000) {
