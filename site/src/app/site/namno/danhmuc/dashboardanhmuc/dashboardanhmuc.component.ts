...
import { RevenuechartComponent, ChartOptions } from '../../../../shared/common/chart/revenuechart/revenuechart.component';
...
@Component({
  ...
  templateUrl: './dashboardanhmuc.component.html',
  styleUrls: ['./dashboardanhmuc.component.scss']
})
